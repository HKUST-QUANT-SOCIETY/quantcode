...
> 现状基线：后端 v5 回归 `987 passed, 4 skipped`；AgentRunner、MCP 身份/组锁定、Memory/能力目录、Blackboard、Evidence、Risk CI、Admin staging、GitGraph/Pop 本地契约和六组适配器均有代码证据。桌面身份/Admin UI、GitHub 后台同步、canonical 组件连接、生产部署队列和模拟盘/实盘接口仍是外部或后续接入项。
