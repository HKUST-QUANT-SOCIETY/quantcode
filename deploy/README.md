...
- **角色**：CI 跑 pytest（当前基线 702+ tests）；qs-cold staging 勘察副本宿主（`/srv/quant/data/migration-staging/...`，见 `specs/data/SPEC.md` §2.1）；Q2 D2a 起加挂 qs-data 只读服务（group 粒度 key，LLM/L1 沙箱只经 market tool 访问）。
