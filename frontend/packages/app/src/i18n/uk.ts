export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Створюється автоматично з відображуваного імені. Можна змінити.",
  ...
  "provider.custom.action.fetchModels": "Отримати моделі",
  "provider.custom.status.fetching": "Отримання моделей…",
  "provider.custom.error.fetchFailed": "Не вдалося отримати моделі. Додайте їх вручну.",
  "provider.custom.hint.apiKeyEnv": "Отримання недоступне, поки ключ API використовує синтаксис {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Підключіть стороннього провайдера, щоб почати використовувати моделі.",
  "sidebar.gettingStarted.line2": "Усе, що потрібно, — базовий URL та API-ключ.",
  ...
  "settings.providers.add.thirdParty": "Додати стороннього провайдера",
  ...
  "quantcode.ssh.user": "Користувач",
  "quantcode.ssh.privateKey": "Приватний ключ",
  "quantcode.ssh.privateKeyHint": "Приватний ключ передається в бекенд лише в пам'яті — не зберігається та не відображається.",
  "quantcode.ssh.connect": "Підключити",
  "quantcode.ssh.connecting": "Підключення…",
  "quantcode.ssh.logWaiting": "Очікування відповіді сервера…",
  "quantcode.ssh.connected": "Підключено",
  "quantcode.ssh.fingerprint": "Відбиток",
  "quantcode.ssh.groups": "Прив'язка до груп",
  "quantcode.ssh.groupSuffix": "група",
  "quantcode.ssh.disconnect": "Відключити",
  "quantcode.ssh.failed": "Не вдалося підключитися",
  "quantcode.ssh.retry": "Повторити",
  "quantcode.ssh.reason.key_rejected": "Ключ відхилено",
  "quantcode.ssh.reason.host_unreachable": "Хост недоступний",
  "quantcode.ssh.reason.unavailable": "Служба SSH-підключення ще не готова",

  "quantcode.capability.title": "Каталог здібностей",
  "quantcode.capability.intro": "Зареєстровані дослідницькі здібності організації. Перевіряйте тут до складання рішення — перевикористовуйте, а не вигадуйте знову.",
  "quantcode.capability.searchPlaceholder": "Пошук здібностей, API-поверхонь чи застосувань…",
  "quantcode.capability.ownerGroup": "Група-власник",
  "quantcode.capability.whenToUse": "Коли використовувати",
  "quantcode.capability.whenNotToReinvent": "Коли не вигадувати знову",
  "quantcode.capability.apiSurface": "Поверхня API",
  "quantcode.capability.source": "джерело",
  "quantcode.capability.noMatch": "Немає відповідних карток здібностей.",
  "quantcode.capability.empty": "Каталог ще не підключено: очікується мета-інструмент list_capabilities (через run trace або ін'єкцію fetcher).",
  "quantcode.memory.title": "Запит Memory",
  "quantcode.memory.intro": "Пошук у груповому та спільному Memory (лише читання, міжгрупово fail-closed).",
  "quantcode.memory.searchPlaceholder": "Пошук у дослідницькій пам'яті…",
  "quantcode.memory.search": "Знайти",
  "quantcode.memory.empty": "Введіть ключові слова для запиту Memory.",
  "quantcode.memory.noResults": "Немає відповідних записів пам'яті.",
  "quantcode.memory.denied": "Немає прав: міжгрупове читання Memory відхилено (fail-closed).",
  "quantcode.memory.unavailable": "Канал Memory ще не підключено: очікується інструмент memory_search (ін'єкція fetcher).",
  "quantcode.memory.score": "Релевантність",
  "quantcode.solution.title": "Панель рішення",
  "quantcode.solution.empty": "У цій сесії ще немає рішення. Використайте /solution <мета>, щоб запустити потік «спочатку рішення».",
  "quantcode.solution.draft": "Рішення не заморожено",
  "quantcode.solution.draftHint": "Рішення не заморожено — інструменти коду недоступні. Спершу обговоріть і заморозьте (тривіальні точкові виправлення — виняток).",
  "quantcode.solution.frozen": "Заморожено",
  "quantcode.solution.rounds": "Раунди обговорення",
  "quantcode.solution.revision": "Правка",
  "quantcode.solution.docHash": "кінець doc_hash",
  "quantcode.solution.solutionId": "ID рішення",
  "quantcode.solution.verdict.conformant": "Реалізація відповідає рішенню",
  "quantcode.solution.verdict.deviation": "Виявлено відхилення",
  "quantcode.solution.verdict.needs_human": "Потрібне рішення людини",
  "quantcode.solution.deviatedFiles": "Список відхилених файлів",
  "quantcode.cmd.solution.title": "Почати рішення (P-10)",
  "quantcode.cmd.solution.description": "Передзаповнює активацію draft_solution; до заморозки інструменти коду недоступні",
  "quantcode.cmd.solution.template": "Мета дослідження:\n<Опишіть тут мету>\n\nВи ПОВИННІ негайно викликати інструмент draft_solution (goal: мета вище). Не відповідайте текстом. До freeze_solution інструменти коду недоступні — не починайте реалізацію.",
  "quantcode.cmd.deploy.title": "Деплой-чорна скринька (P-09)",
  "quantcode.cmd.deploy.description": "Передзаповнює виклик deploy_alphaflow; деплой вимагає схвалення kind=deploy",
  "quantcode.cmd.deploy.template": "Джерело коду для деплою:\n<Шлях або опис тут>\n\nВи ПОВИННІ негайно викликати інструмент deploy_alphaflow (source: текст вище). Не відповідайте текстом. Звітуйте лише про успіх/невдачу адаптації та шлях artifact — ніколи не розкривайте внутрішню структуру AlphaFlow.",
  "quantcode.admin.title": "Консоль Admin",
  "quantcode.admin.intro": "Запитуйте стан організації природною мовою; результати мета-інструментів admin_* повертаються сюди, згруповані за групою → учасником → статусом.",
  "quantcode.admin.inputPlaceholder": "Запитати: нещодавня робота груп / стан модулів / журнали помилок…",
  "quantcode.admin.send": "Надіслати запит",
  "quantcode.admin.presetRuns": "Нещодавня робота груп",
  "quantcode.admin.presetModules": "Стан модулів",
  "quantcode.admin.presetErrors": "Журнали помилок груп",
  "quantcode.admin.sent": "Запит надіслано; результати з'являться, коли інструменти admin_* повернуться.",
  "quantcode.admin.waiting": "Очікування результатів admin_*…",
  "quantcode.admin.emptyTitle": "Канал даних ще не підключено",
  "quantcode.admin.empty": "Після надсилання запиту результати admin_list_runs / admin_errors з'являться тут. Лише справжні дані — без вигадок.",
  "quantcode.admin.errorsEmpty": "Помилок не зафіксовано; усі групи працюють штатно.",
  "quantcode.admin.filterAll": "Усі",
  "quantcode.admin.reportsEntry": "Звіти",
  "quantcode.admin.tasksEntry": "Завдання",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph: усі репозиторії",
  "quantcode.gitgraph.intro": "Актуальний стан дерева всіх репозиторіїв: вузли з push за останні 7 днів виділені червоним і підняті вгору; фільтр за групою.",
  "quantcode.gitgraph.check": "Перевірити оновлення",
  "quantcode.gitgraph.checked": "Остання перевірка",
  "quantcode.gitgraph.emptyTitle": "Канал даних ще не підключено",
  "quantcode.gitgraph.empty": "Натисніть «Перевірити оновлення» — результати admin_repo_status / admin_package_updates з'являться тут. Лише справжні дані.",
  "quantcode.gitgraph.waiting": "Очікування результатів admin_repo_status…",
  "quantcode.gitgraph.updated": "Є оновлення",
  "quantcode.gitgraph.packagesEmpty": "Усі залежності актуальні.",
  "quantcode.gitgraph.package": "залежність",
  "quantcode.gitgraph.open": "Відкрити GitGraph",
  "quantcode.pop.repoTitle": "У репозиторії нові коміти",
  "quantcode.pop.packageTitle": "Доступне оновлення залежності",
  "quantcode.pop.viewGitgraph": "Відкрити GitGraph",
}
