export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Généré automatiquement à partir du nom d'affichage. Vous pouvez le modifier.",
  ...
  "provider.custom.action.fetchModels": "Récupérer les modèles",
  "provider.custom.status.fetching": "Récupération des modèles…",
  "provider.custom.error.fetchFailed": "Échec de la récupération des modèles. Ajoutez-les manuellement.",
  "provider.custom.hint.apiKeyEnv": "La récupération est indisponible tant que la clé API utilise la syntaxe {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Connectez un fournisseur tiers pour commencer à utiliser des modèles.",
  "sidebar.gettingStarted.line2": "Il vous suffit d'une URL de base et d'une clé API.",
  ...
  "settings.providers.add.thirdParty": "Ajouter un fournisseur tiers",
  ...
  "quantcode.ssh.host": "Hôte",
  "quantcode.ssh.user": "Utilisateur",
  "quantcode.ssh.privateKey": "Clé privée",
  "quantcode.ssh.privateKeyHint": "La clé privée est transmise au backend en mémoire uniquement — jamais stockée ni affichée.",
  "quantcode.ssh.connect": "Connexion",
  "quantcode.ssh.connecting": "Connexion en cours…",
  "quantcode.ssh.logWaiting": "En attente de la réponse du serveur…",
  "quantcode.ssh.connected": "Connecté",
  "quantcode.ssh.fingerprint": "Empreinte",
  "quantcode.ssh.groups": "Groupes liés",
  "quantcode.ssh.groupSuffix": "groupe",
  "quantcode.ssh.disconnect": "Déconnecter",
  "quantcode.ssh.failed": "Échec de la connexion",
  "quantcode.ssh.retry": "Réessayer",
  "quantcode.ssh.reason.key_rejected": "Clé refusée",
  "quantcode.ssh.reason.host_unreachable": "Hôte injoignable",
  "quantcode.ssh.reason.unavailable": "Le service de connexion SSH n'est pas encore prêt",

  "quantcode.capability.title": "Catalogue de capacités",
  "quantcode.capability.intro": "Capacités de recherche enregistrées par l'organisation. Consultez ici avant de rédiger une solution — réutiliser plutôt que réinventer.",
  "quantcode.capability.searchPlaceholder": "Rechercher capacités, surfaces d'API ou usages…",
  "quantcode.capability.ownerGroup": "Groupe propriétaire",
  "quantcode.capability.whenToUse": "Quand utiliser",
  "quantcode.capability.whenNotToReinvent": "Quand ne pas réinventer",
  "quantcode.capability.apiSurface": "Surface d'API",
  "quantcode.capability.source": "source",
  "quantcode.capability.noMatch": "Aucune carte de capacité correspondante.",
  "quantcode.capability.empty": "Catalogue non encore connecté : en attente de l'outil méta list_capabilities (via le run trace ou un fetcher injecté).",
  "quantcode.memory.title": "Recherche Memory",
  "quantcode.memory.intro": "Interroger le Memory du groupe et partagé (lecture seule, inter-groupe fail-closed).",
  "quantcode.memory.searchPlaceholder": "Rechercher dans la mémoire de recherche…",
  "quantcode.memory.search": "Rechercher",
  "quantcode.memory.empty": "Saisissez des mots-clés pour interroger le Memory.",
  "quantcode.memory.noResults": "Aucune entrée de mémoire correspondante.",
  "quantcode.memory.denied": "Permission refusée : lecture inter-groupe du Memory refusée (fail-closed).",
  "quantcode.memory.unavailable": "Canal Memory non connecté : en attente de l'outil memory_search (fetcher injectable).",
  "quantcode.memory.score": "Pertinence",
  "quantcode.solution.title": "Panneau de solution",
  "quantcode.solution.empty": "Aucune solution dans cette session. Utilisez /solution <objectif> pour démarrer le flux solution-first.",
  "quantcode.solution.draft": "Solution non figée",
  "quantcode.solution.draftHint": "Solution non figée — outils de code indisponibles. Discutez puis figez d'abord (les correctifs triviaux ponctuels sont exemptés).",
  "quantcode.solution.frozen": "Figée",
  "quantcode.solution.rounds": "Tours de discussion",
  "quantcode.solution.revision": "Révision",
  "quantcode.solution.docHash": "fin du doc_hash",
  "quantcode.solution.solutionId": "ID de solution",
  "quantcode.solution.verdict.conformant": "L'implémentation correspond à la solution",
  "quantcode.solution.verdict.deviation": "Écart détecté",
  "quantcode.solution.verdict.needs_human": "Décision humaine requise",
  "quantcode.solution.deviatedFiles": "Fichiers en écart",
  "quantcode.cmd.solution.title": "Démarrer la solution (P-10)",
  "quantcode.cmd.solution.description": "Préremplit l'activation de draft_solution ; outils de code indisponibles tant que la solution n'est pas figée",
  "quantcode.cmd.solution.template": "Objectif de recherche :\n<Décrivez ici l'objectif>\n\nTu DOIS appeler l'outil draft_solution maintenant (goal : l'objectif ci-dessus). Ne réponds pas par du texte. Les outils de code restent indisponibles jusqu'au freeze_solution — ne commence pas l'implémentation.",
  "quantcode.cmd.deploy.title": "Déploiement boîte noire (P-09)",
  "quantcode.cmd.deploy.description": "Préremplit l'appel deploy_alphaflow ; le déploiement requiert l'approbation kind=deploy",
  "quantcode.cmd.deploy.template": "Source de code à déployer :\n<Chemin ou description ici>\n\nTu DOIS appeler l'outil deploy_alphaflow maintenant (source : le texte ci-dessus). Ne réponds pas par du texte. Ne rapporte que le succès/l'échec d'adaptation et le chemin d'artefact — ne révèle jamais la structure interne d'AlphaFlow.",
  "quantcode.admin.title": "Console Admin",
  "quantcode.admin.intro": "Interrogez l'état de l'organisation en langage naturel ; les résultats des méta-outils admin_* reviennent ici, regroupés par groupe → membre → statut.",
  "quantcode.admin.inputPlaceholder": "Demander : activité récente par groupe / état des modules / journaux d'erreurs…",
  "quantcode.admin.send": "Envoyer la requête",
  "quantcode.admin.presetRuns": "Activité récente par groupe",
  "quantcode.admin.presetModules": "État des modules",
  "quantcode.admin.presetErrors": "Journaux d'erreurs par groupe",
  "quantcode.admin.sent": "Requête envoyée ; les résultats apparaîtront au retour des outils admin_*.",
  "quantcode.admin.waiting": "En attente des résultats admin_*…",
  "quantcode.admin.emptyTitle": "Canal de données non encore connecté",
  "quantcode.admin.empty": "Après l'envoi, les résultats d'admin_list_runs / admin_errors arriveront ici. Données réelles uniquement — aucun simulacre.",
  "quantcode.admin.errorsEmpty": "Aucune erreur enregistrée ; tous les groupes fonctionnent normalement.",
  "quantcode.admin.filterAll": "Tout",
  "quantcode.admin.reportsEntry": "Rapports",
  "quantcode.admin.tasksEntry": "Tâches",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "Vue GitGraph de tous les dépôts",
  "quantcode.gitgraph.intro": "Dernier état de l'arborescence de tous les dépôts : les nœuds poussés depuis moins de 7 jours sont en rouge et en tête ; filtrable par groupe.",
  "quantcode.gitgraph.check": "Vérifier les mises à jour",
  "quantcode.gitgraph.checked": "Dernière vérification",
  "quantcode.gitgraph.emptyTitle": "Canal de données non encore connecté",
  "quantcode.gitgraph.empty": "Cliquez sur « Vérifier les mises à jour » ; les résultats d'admin_repo_status / admin_package_updates arriveront ici. Données réelles uniquement.",
  "quantcode.gitgraph.waiting": "En attente des résultats admin_repo_status…",
  "quantcode.gitgraph.updated": "Mis à jour",
  "quantcode.gitgraph.packagesEmpty": "Toutes les dépendances sont à jour.",
  "quantcode.gitgraph.package": "dépendance",
  "quantcode.gitgraph.open": "Ouvrir GitGraph",
  "quantcode.pop.repoTitle": "Nouveaux commits dans le dépôt",
  "quantcode.pop.packageTitle": "Mise à jour de dépendance disponible",
  "quantcode.pop.viewGitgraph": "Voir GitGraph",
}
