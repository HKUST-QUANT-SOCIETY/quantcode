export const dict = {
  "quantcode.servers.managedRuntime": "QuantCode updates with the desktop app or your organization's release. Add the URL of a configured research host to connect.",
  ...
  "provider.custom.field.providerID.auto": "Auto-generated from the display name. You can edit it.",
  ...
  "provider.custom.action.fetchModels": "Fetch models",
  "provider.custom.status.fetching": "Fetching models…",
  "provider.custom.error.fetchFailed": "Failed to fetch models. Add them manually.",
  "provider.custom.hint.apiKeyEnv": "Fetching is unavailable while the API key uses {env:VAR} syntax.",
  ...
  "prompt.placeholder.commands": "Describe a task, / for commands, @ for context…",
  ...
  "sidebar.gettingStarted.line1": "Connect a third-party provider to start using models.",
  "sidebar.gettingStarted.line2": "All you need is a base URL and an API key.",
  ...
  "settings.providers.add.thirdParty": "Add third-party provider",
  ...
  "quantcode.gate.waitingApproval": "Waiting for human approval",
  "quantcode.gate.approve": "Approve",
  "quantcode.gate.reject": "Reject",
  "quantcode.gate.resuming": "Resuming…",
  "quantcode.gate.resumeSent": "Resume decision sent, waiting for the agent to continue",
  "quantcode.gate.resumeFailed": "Failed to send resume decision",
  "quantcode.gate.riskMetrics": "Risk metrics",
  ...
  "quantcode.monitor.empty": "No tasks in this session yet",
  "quantcode.monitor.recentRuns": "Recent tasks",
  "quantcode.monitor.runs": "tasks",
  "quantcode.monitor.successRate": "Success rate",
  "quantcode.monitor.avgDuration": "Avg duration",
  "quantcode.monitor.errorRate": "Error rate",
  "quantcode.native.compose.description": "Describe the task and continue in the current QuantCode session",
  "quantcode.native.goal.title": "Set task goal",
  "quantcode.native.goal.description": "Define the outcome and acceptance criteria for this task",
  "quantcode.native.goal.template": "Goal:\n<Describe the outcome>\n\nAcceptance criteria:\n<List the evidence needed to confirm completion>",
  "quantcode.native.solution.title": "Prepare a solution",
  "quantcode.native.solution.description": "Describe the change, affected files and acceptance criteria",
  "quantcode.native.solution.template": "Proposed change:\n<Describe the change>\n\nFiles and scope:\n<List the affected files or components>\n\nAcceptance criteria:\n<Describe how completion will be checked>",
  "quantcode.native.skill": "Group skills load automatically",
  "quantcode.native.submitted": "Task submitted. Follow its progress in the task view.",
  "quantcode.native.return": "Return to task",
  "quantcode.native.checking": "Checking task service…",
  "quantcode.native.unavailable": "Cannot verify the task service. Reconnect before submitting.",
  "quantcode.native.legacyRecovery": "This archived task is read-only. Recovery is unavailable until its original execution environment is verified.",

  "quantcode.goal.title": "Set goal (judge after run)",
  "quantcode.goal.description": "Prefill a goal template and record acceptance evidence when the task finishes",
  "quantcode.goal.template":
    "Goal:\n<Describe verifiable completion criteria here, e.g.: produce a factor report with IC >= 0.03>\n\nRequirements: when the task finishes, record the evidence and reasoning used to verify completion.",
  ...
  "quantcode.capability.title": "Capability Catalog",
  "quantcode.capability.intro": "Registered organization capabilities. Check here before drafting a solution — reuse, don't reinvent.",
  "quantcode.capability.searchPlaceholder": "Search capabilities, API surfaces or use cases…",
  "quantcode.capability.ownerGroup": "Owner group",
  "quantcode.capability.whenToUse": "When to use",
  "quantcode.capability.whenNotToReinvent": "When not to reinvent",
  ...
  "quantcode.capability.loading": "Loading capability catalog…",
  "quantcode.capability.unavailable": "Capability catalog is unavailable: the server directory could not be read.",
  ...
  "quantcode.memory.search": "Search",
  "quantcode.memory.empty": "Type keywords to query Memory.",
  "quantcode.memory.noResults": "No matching memory entries.",
  "quantcode.memory.denied": "No permission: cross-group Memory read was denied (fail-closed).",
  "quantcode.memory.unavailable": "Memory search is not connected yet: waiting for the search_memory tool.",
  "quantcode.memory.score": "Relevance",
  "quantcode.solution.title": "Solution Panel",
  "quantcode.solution.empty": "No solution in this session yet. Use /solution <goal> to start the solution-first flow.",
  "quantcode.solution.draft": "Solution not frozen",
  "quantcode.solution.draftHint": "Solution not frozen — code tools are unavailable. Discuss and freeze the solution first (trivial single-point fixes are exempt).",
  "quantcode.solution.frozen": "Frozen",
  "quantcode.solution.rounds": "Discussion rounds",
  "quantcode.solution.revision": "Revision",
  "quantcode.solution.docHash": "doc_hash tail",
  "quantcode.solution.solutionId": "Solution ID",
  "quantcode.solution.verdict.conformant": "Implementation matches the solution",
  "quantcode.solution.verdict.deviation": "Deviation detected",
  "quantcode.solution.verdict.needs_human": "Needs human decision",
  "quantcode.solution.deviatedFiles": "Deviated files",
  "quantcode.cmd.solution.title": "Start solution (P-10)",
  "quantcode.cmd.solution.description": "Prefill a draft_solution activation; code tools stay unavailable until the solution is frozen",
  "quantcode.cmd.solution.template": "Research goal:\n<Describe the research goal here>\n\nYou MUST call the draft_solution tool now (goal: the text above). Do not reply with text. Code tools are unavailable until the solution is frozen (freeze_solution) — do not start implementing.",
  "quantcode.cmd.deploy.title": "Black-box deploy (P-09)",
  "quantcode.cmd.deploy.description": "Prefill a deploy_alphaflow call; deployment requires kind=deploy approval and never reveals internals",
  "quantcode.cmd.deploy.template": "Code source to deploy:\n<Path or description here>\n\nYou MUST call the deploy_alphaflow tool now (source: the text above). Do not reply with text. Report only adaptation success/failure and the artifact path — never reveal AlphaFlow internal structure.",
  "quantcode.admin.title": "Admin Console",
  "quantcode.admin.intro": "Ask org status in natural language; results from the admin_* meta tools flow back here, grouped by group → member → status.",
  "quantcode.admin.inputPlaceholder": "Ask: recent runs per group / module status / error logs…",
  "quantcode.admin.send": "Send query",
  "quantcode.admin.presetRuns": "Recent runs per group",
  "quantcode.admin.presetModules": "Module status",
  "quantcode.admin.presetErrors": "Error logs per group",
  "quantcode.admin.sent": "Query sent; results appear when the admin_* tools flow back.",
  "quantcode.admin.waiting": "Waiting for admin_* results…",
  "quantcode.admin.emptyTitle": "Data channel not connected yet",
  "quantcode.admin.empty": "Send a semantic query; results from admin_list_runs / admin_errors will land here. Real data only — no mock.",
  "quantcode.admin.errorsEmpty": "No errors recorded; all groups are healthy.",
  "quantcode.admin.filterAll": "All",
  "quantcode.admin.reportsEntry": "Reports",
  "quantcode.admin.tasksEntry": "Tasks",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph Repository View",
  "quantcode.gitgraph.intro": "Latest tree state of every org repo: nodes pushed within 7 days are highlighted red and sorted to the top; filter by group.",
  "quantcode.gitgraph.check": "Check updates",
  "quantcode.gitgraph.checked": "Last checked",
  "quantcode.gitgraph.emptyTitle": "Data channel not connected yet",
  "quantcode.gitgraph.empty": "Click “Check updates”; results from admin_repo_status / admin_package_updates will land here. Real data only — no mock.",
  "quantcode.gitgraph.waiting": "Waiting for admin_repo_status results…",
  "quantcode.gitgraph.updated": "Updated",
  "quantcode.gitgraph.packagesEmpty": "All dependencies are up to date.",
  "quantcode.gitgraph.package": "dependency",
  "quantcode.gitgraph.open": "Open GitGraph",
  "quantcode.pop.repoTitle": "Repo has new commits",
  "quantcode.pop.packageTitle": "Dependency update available",
  "quantcode.pop.viewGitgraph": "View GitGraph",
}
