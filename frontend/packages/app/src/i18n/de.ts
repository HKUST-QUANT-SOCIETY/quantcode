...
export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Wird aus dem Anzeigenamen automatisch generiert. Sie können ihn bearbeiten.",
  ...
  "provider.custom.action.fetchModels": "Modelle abrufen",
  "provider.custom.status.fetching": "Modelle werden abgerufen…",
  "provider.custom.error.fetchFailed": "Modelle konnten nicht abgerufen werden. Fügen Sie sie manuell hinzu.",
  "provider.custom.hint.apiKeyEnv": "Das Abrufen ist nicht verfügbar, während der API-Schlüssel die Syntax {env:VAR} verwendet.",
  ...
  "sidebar.gettingStarted.line1": "Verbinden Sie einen Drittanbieter, um Modelle zu nutzen.",
  "sidebar.gettingStarted.line2": "Sie benötigen nur eine Basis-URL und einen API-Schlüssel.",
  ...
  "settings.providers.add.thirdParty": "Drittanbieter hinzufügen",
  ...
  "quantcode.ssh.user": "Benutzer",
  "quantcode.ssh.privateKey": "Privater Schlüssel",
  "quantcode.ssh.privateKeyHint": "Der private Schlüssel wird nur im Speicher an das Backend übergeben — nicht gespeichert oder angezeigt.",
  "quantcode.ssh.connect": "Verbinden",
  "quantcode.ssh.connecting": "Verbindung wird hergestellt…",
  "quantcode.ssh.logWaiting": "Warte auf Antwort des Servers…",
  "quantcode.ssh.connected": "Verbunden",
  "quantcode.ssh.fingerprint": "Fingerprint",
  "quantcode.ssh.groups": "Gruppenzuordnung",
  "quantcode.ssh.groupSuffix": "Gruppe",
  "quantcode.ssh.disconnect": "Trennen",
  "quantcode.ssh.failed": "Verbindung fehlgeschlagen",
  "quantcode.ssh.retry": "Erneut versuchen",
  "quantcode.ssh.reason.key_rejected": "Schlüssel abgelehnt",
  "quantcode.ssh.reason.host_unreachable": "Host nicht erreichbar",
  "quantcode.ssh.reason.unavailable": "Der SSH-Verbindungsdienst ist noch nicht bereit",

  "quantcode.capability.title": "Fähigkeitenkatalog",
  "quantcode.capability.intro": "Registrierte Organisationsfähigkeiten. Vor dem Lösungsentwurf hier nachsehen — wiederverwenden statt neu erfinden.",
  "quantcode.capability.searchPlaceholder": "Fähigkeiten, API-Flächen oder Anwendungsfälle suchen…",
  "quantcode.capability.ownerGroup": "Eigentümergruppe",
  "quantcode.capability.whenToUse": "Wann verwenden",
  "quantcode.capability.whenNotToReinvent": "Wann nicht neu erfinden",
  "quantcode.capability.apiSurface": "API-Fläche",
  "quantcode.capability.source": "Quelle",
  "quantcode.capability.noMatch": "Keine passenden Fähigkeitenkarten.",
  "quantcode.capability.empty": "Fähigkeitenkatalog noch nicht verbunden: list_capabilities-Metawarte offen (per Run-Trace oder injiziertem Fetcher).",
  "quantcode.memory.title": "Memory-Abfrage",
  "quantcode.memory.intro": "Gruppen- und geteiltes Memory durchsuchen (schreibgeschützt, gruppenübergreifend fail-closed).",
  "quantcode.memory.searchPlaceholder": "Research-Memory durchsuchen…",
  "quantcode.memory.search": "Suchen",
  "quantcode.memory.empty": "Stichwörter eingeben, um Memory abzufragen.",
  "quantcode.memory.noResults": "Keine passenden Memory-Einträge.",
  "quantcode.memory.denied": "Keine Berechtigung: gruppenübergreifender Memory-Leszugriff verweigert (fail-closed).",
  "quantcode.memory.unavailable": "Memory-Suche noch nicht verbunden: memory_search-Werkzeug offen (injizierbarer Fetcher).",
  "quantcode.memory.score": "Relevanz",
  "quantcode.solution.title": "Lösungspanel",
  "quantcode.solution.empty": "Noch keine Lösung in dieser Sitzung. Mit /solution <Ziel> den Lösung-first-Ablauf starten.",
  "quantcode.solution.draft": "Lösung nicht eingefroren",
  "quantcode.solution.draftHint": "Lösung nicht eingefroren — Code-Werkzeuge sind gesperrt. Erst diskutieren und einfrieren (triviale Ein-Punkt-Fixes sind ausgenommen).",
  "quantcode.solution.frozen": "Eingefroren",
  "quantcode.solution.rounds": "Diskussionsrunden",
  "quantcode.solution.revision": "Überarbeitung",
  "quantcode.solution.docHash": "doc_hash-Ende",
  "quantcode.solution.solutionId": "Lösungs-ID",
  "quantcode.solution.verdict.conformant": "Umsetzung entspricht der Lösung",
  "quantcode.solution.verdict.deviation": "Abweichung erkannt",
  "quantcode.solution.verdict.needs_human": "Menschliche Entscheidung erforderlich",
  "quantcode.solution.deviatedFiles": "Abweichende Dateien",
  "quantcode.cmd.solution.title": "Lösung starten (P-10)",
  "quantcode.cmd.solution.description": "draft_solution-Aktivierung vorfüllen; bis zum Einfrieren bleiben Code-Werkzeuge gesperrt",
  "quantcode.cmd.solution.template": "Forschungsziel:\n<Ziel hier beschreiben>\n\nDu MUSST jetzt das draft_solution-Werkzeug aufrufen (goal: das Ziel oben). Keine Textantwort. Bis freeze_solution erfolgt ist, bleiben Code-Werkzeuge gesperrt — nicht mit der Umsetzung beginnen.",
  "quantcode.cmd.deploy.title": "Blackbox-Deployment (P-09)",
  "quantcode.cmd.deploy.description": "deploy_alphaflow-Aufruf vorfüllen; Deployment erfordert kind=deploy-Freigabe",
  "quantcode.cmd.deploy.template": "Code-Quelle zum Deployen:\n<Pfad oder Beschreibung hier eintragen>\n\nDu MUSST jetzt das deploy_alphaflow-Werkzeug aufrufen (source: der Text oben). Keine Textantwort. Nur Anpassungs-Erfolg/Misserfolg und Artefakt-Pfad berichten — AlphaFlow-Interna niemals preisgeben.",
  "quantcode.admin.title": "Admin-Konsole",
  "quantcode.admin.intro": "Organisationsstatus in natürlicher Sprache abfragen; Ergebnisse der admin_*-Meta-Tools fließen hier nach Gruppe → Person → Status zurück.",
  "quantcode.admin.inputPlaceholder": "Fragen: kürzliche Arbeit pro Gruppe / Modulstatus / Fehlerprotokolle…",
  "quantcode.admin.send": "Abfrage senden",
  "quantcode.admin.presetRuns": "Kürzliche Arbeit pro Gruppe",
  "quantcode.admin.presetModules": "Modulstatus",
  "quantcode.admin.presetErrors": "Fehlerprotokolle pro Gruppe",
  "quantcode.admin.sent": "Abfrage gesendet; Ergebnisse erscheinen, sobald die admin_*-Tools zurückmelden.",
  "quantcode.admin.waiting": "Warte auf admin_*-Ergebnisse…",
  "quantcode.admin.emptyTitle": "Datenkanal noch nicht verbunden",
  "quantcode.admin.empty": "Nach dem Senden landen die Ergebnisse von admin_list_runs / admin_errors hier. Nur echte Daten — keine erfundenen.",
  "quantcode.admin.errorsEmpty": "Keine Fehler aufgezeichnet; alle Gruppen laufen normal.",
  "quantcode.admin.filterAll": "Alle",
  "quantcode.admin.reportsEntry": "Berichte",
  "quantcode.admin.tasksEntry": "Aufgaben",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph-Repository-Ansicht",
  "quantcode.gitgraph.intro": "Neuester Baumzustand aller Org-Repos: Nodes mit Push innerhalb von 7 Tagen sind rot markiert und stehen oben; nach Gruppe filterbar.",
  "quantcode.gitgraph.check": "Updates prüfen",
  "quantcode.gitgraph.checked": "Zuletzt geprüft",
  "quantcode.gitgraph.emptyTitle": "Datenkanal noch nicht verbunden",
  "quantcode.gitgraph.empty": "Nach Klick auf „Updates prüfen“ landen die Ergebnisse von admin_repo_status / admin_package_updates hier. Nur echte Daten.",
  "quantcode.gitgraph.waiting": "Warte auf admin_repo_status-Ergebnisse…",
  "quantcode.gitgraph.updated": "Aktualisiert",
  "quantcode.gitgraph.packagesEmpty": "Alle Abhängigkeiten sind aktuell.",
  "quantcode.gitgraph.package": "Abhängigkeit",
  "quantcode.gitgraph.open": "GitGraph öffnen",
  "quantcode.pop.repoTitle": "Repo hat neue Commits",
  "quantcode.pop.packageTitle": "Abhängigkeits-Update verfügbar",
  "quantcode.pop.viewGitgraph": "GitGraph anzeigen",
