...
export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Genereres automatisk fra visningsnavnet. Du kan redigere det.",
  ...
  "provider.custom.error.fetchFailed": "Kunne ikke hente modeller. Legg dem til manuelt.",
  "provider.custom.hint.apiKeyEnv": "Henting er utilgjengelig mens API-nøkkelen bruker syntaksen {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Koble til en tredjepartsleverandør for å begynne å bruke modeller.",
  "sidebar.gettingStarted.line2": "Alt du trenger er en basis-URL og en API-nøkkel.",
  ...
  "settings.providers.add.thirdParty": "Legg til tredjepartsleverandør",
  ...
  "quantcode.ssh.host": "Vert",
  "quantcode.ssh.user": "Bruker",
  "quantcode.ssh.privateKey": "Privat nøkkel",
  "quantcode.ssh.privateKeyHint": "Den private nøkkelen sendes kun i minnet til backenden — lagres eller vises aldri.",
  "quantcode.ssh.connect": "Koble til",
  "quantcode.ssh.connecting": "Kobler til…",
  "quantcode.ssh.logWaiting": "Venter på svar fra serveren…",
  "quantcode.ssh.connected": "Tilkoblet",
  "quantcode.ssh.fingerprint": "Fingeravtrykk",
  "quantcode.ssh.groups": "Gruppetilknytning",
  "quantcode.ssh.groupSuffix": "gruppe",
  "quantcode.ssh.disconnect": "Koble fra",
  "quantcode.ssh.failed": "Tilkoblingen mislyktes",
  "quantcode.ssh.retry": "Prøv igjen",
  "quantcode.ssh.reason.key_rejected": "Nøkkel avvist",
  "quantcode.ssh.reason.host_unreachable": "Verten er utilgjengelig",
  "quantcode.ssh.reason.unavailable": "SSH-tilkoblingstjenesten er ikke klar ennå",

  "quantcode.capability.title": "Kapabilitetskatalog",
  "quantcode.capability.intro": "Organisasjonens registrerte kapabiliteter. Sjekk her før løsningsutforming — gjenbruk i stedet for å finne opp på nytt.",
  "quantcode.capability.searchPlaceholder": "Søk kapabiliteter, API-flater eller bruksområder…",
  "quantcode.capability.ownerGroup": "Eiergruppe",
  "quantcode.capability.whenToUse": "Når brukes",
  "quantcode.capability.whenNotToReinvent": "Når skal man ikke finne opp på nytt",
  "quantcode.capability.apiSurface": "API-flate",
  "quantcode.capability.source": "kilde",
  "quantcode.capability.noMatch": "Ingen matchende kapabilitetskort.",
  "quantcode.capability.empty": "Kapabilitetskatalogen er ikke koblet ennå: venter på list_capabilities-meta-verktøyet (via run trace eller injisert fetcher).",
  "quantcode.memory.title": "Memory-søk",
  "quantcode.memory.intro": "Søk i gruppe- og delt Memory (skrivebeskyttet, på tvers av grupper fail-closed).",
  "quantcode.memory.searchPlaceholder": "Søk i forskningshukommelsen…",
  "quantcode.memory.search": "Søk",
  "quantcode.memory.empty": "Skriv inn nøkkelord for å spørre Memory.",
  "quantcode.memory.noResults": "Ingen matchende memory-oppføringer.",
  "quantcode.memory.denied": "Ingen tilgang: kryssgruppe-lesing av Memory avvist (fail-closed).",
  "quantcode.memory.unavailable": "Memory-kanalen er ikke koblet ennå: venter på memory_search-verktøyet (injiserbar fetcher).",
  "quantcode.memory.score": "Relevans",
  "quantcode.solution.title": "Løsningspanel",
  "quantcode.solution.empty": "Ingen løsning i denne økten ennå. Bruk /solution <mål> for å starte løsning-først-flyten.",
  "quantcode.solution.draft": "Løsning ikke frossen",
  "quantcode.solution.draftHint": "Løsning ikke frossen — kodeverktøy utilgjengelige. Diskuter og frys først (trivielle enkeltfiks er unntatt).",
  "quantcode.solution.frozen": "Frosset",
  "quantcode.solution.rounds": "Diskusjonsrunder",
  "quantcode.solution.revision": "Revisjon",
  "quantcode.solution.docHash": "doc_hash-hale",
  "quantcode.solution.solutionId": "Løsnings-ID",
  "quantcode.solution.verdict.conformant": "Implementeringen samsvarer med løsningen",
  "quantcode.solution.verdict.deviation": "Avvik oppdaget",
  "quantcode.solution.verdict.needs_human": "Krever menneskelig avgjørelse",
  "quantcode.solution.deviatedFiles": "Avvikende filer",
  "quantcode.cmd.solution.title": "Start løsning (P-10)",
  "quantcode.cmd.solution.description": "Forhåndsutfyller draft_solution-aktivering; kodeverktøy forblir låst til frysing",
  "quantcode.cmd.solution.template": "Forskningsmål:\n<Beskriv målet her>\n\nDu MÅ nå kalle draft_solution-verktøyet (goal: målet over). Ikke svar med tekst. Kodeverktøy er utilgjengelige til freeze_solution — ikke start implementering.",
  "quantcode.cmd.deploy.title": "Blackbox-deployment (P-09)",
  "quantcode.cmd.deploy.description": "Forhåndsutfyller deploy_alphaflow-kall; deployment krever kind=deploy-godkjenning",
  "quantcode.cmd.deploy.template": "Kildekode som skal deployes:\n<Sti eller beskrivelse her>\n\nDu MÅ nå kalle deploy_alphaflow-verktøyet (source: teksten over). Ikke svar med tekst. Rapporter kun tilpasningssuksess/svikt og artefaktsti — avslør aldri AlphaFlows interne struktur.",
  "quantcode.admin.title": "Admin-konsoll",
  "quantcode.admin.intro": "Spør om organisasjonens tilstand på naturlig språk; resultatene fra admin_*-metaverktøyene flyter tilbake hit, gruppert etter gruppe → person → status.",
  "quantcode.admin.inputPlaceholder": "Spør: nylig arbeid per gruppe / modulstatus / feillogger…",
  "quantcode.admin.send": "Send spørring",
  "quantcode.admin.presetRuns": "Nylig arbeid per gruppe",
  "quantcode.admin.presetModules": "Modulstatus",
  "quantcode.admin.presetErrors": "Feillogger per gruppe",
  "quantcode.admin.sent": "Spørring sendt; resultatene vises når admin_*-verktøyene svarer.",
  "quantcode.admin.waiting": "Venter på admin_*-resultater…",
  "quantcode.admin.emptyTitle": "Datakanalen er ikke koblet til ennå",
  "quantcode.admin.empty": "Etter sending havner resultatene av admin_list_runs / admin_errors her. Kun ekte data — ingen oppdiktning.",
  "quantcode.admin.errorsEmpty": "Ingen feil registrert; alle grupper kjører normalt.",
  "quantcode.admin.filterAll": "Alle",
  "quantcode.admin.reportsEntry": "Rapporter",
  "quantcode.admin.tasksEntry": "Oppgaver",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph-visning av alle repoer",
  "quantcode.gitgraph.intro": "Siste tretilstand for alle repoer: noder med push siste 7 dager utheves rødt og ligger øverst; filtrer per gruppe.",
  "quantcode.gitgraph.check": "Sjekk oppdateringer",
  "quantcode.gitgraph.checked": "Sist sjekket",
  "quantcode.gitgraph.emptyTitle": "Datakanalen er ikke koblet til ennå",
  "quantcode.gitgraph.empty": "Klikk «Sjekk oppdateringer»; resultatene av admin_repo_status / admin_package_updates havner her. Kun ekte data.",
  "quantcode.gitgraph.waiting": "Venter på admin_repo_status-resultater…",
  "quantcode.gitgraph.updated": "Oppdatert",
  "quantcode.gitgraph.packagesEmpty": "Alle avhengigheter er oppdaterte.",
  "quantcode.gitgraph.package": "avhengighet",
  "quantcode.gitgraph.open": "Åpne GitGraph",
  "quantcode.pop.repoTitle": "Repoet har nye commits",
  "quantcode.pop.packageTitle": "Avhengighetsoppdatering tilgjengelig",
