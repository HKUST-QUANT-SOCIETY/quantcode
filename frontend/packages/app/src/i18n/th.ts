export const dict = {
  ...
  "provider.custom.field.providerID.auto": "สร้างโดยอัตโนมัติจากชื่อที่แสดง คุณสามารถแก้ไขได้",
  ...
  "provider.custom.action.fetchModels": "ดึงข้อมูลโมเดล",
  "provider.custom.status.fetching": "กำลังดึงข้อมูลโมเดล…",
  "provider.custom.error.fetchFailed": "ดึงข้อมูลโมเดลไม่สำเร็จ โปรดเพิ่มด้วยตนเอง",
  "provider.custom.hint.apiKeyEnv": "การดึงข้อมูลโมเดลใช้ไม่ได้ขณะที่คีย์ API ใช้ไวยากรณ์ {env:VAR}",
  ...
  "sidebar.gettingStarted.line1": "เชื่อมต่อผู้ให้บริการจากบุคคลที่สามเพื่อเริ่มใช้งานโมเดล",
  "sidebar.gettingStarted.line2": "คุณต้องมีเพียง URL พื้นฐานและคีย์ API เท่านั้น",
  ...
  "settings.providers.add.thirdParty": "เพิ่มผู้ให้บริการจากบุคคลที่สาม",
  ...
  "quantcode.ssh.host": "โฮสต์",
  "quantcode.ssh.user": "ชื่อผู้ใช้",
  "quantcode.ssh.privateKey": "คีย์ส่วนตัว",
  "quantcode.ssh.privateKeyHint": "คีย์ส่วนตัวจะถูกส่งต่อให้แบ็กเอนด์ในหน่วยความจำเท่านั้น — ไม่จัดเก็บและไม่แสดงผล",
  "quantcode.ssh.connect": "เชื่อมต่อ",
  "quantcode.ssh.connecting": "กำลังเชื่อมต่อ…",
  "quantcode.ssh.logWaiting": "กำลังรอการตอบสนองของเซิร์ฟเวอร์…",
  "quantcode.ssh.connected": "เชื่อมต่อแล้ว",
  "quantcode.ssh.fingerprint": "ลายนิ้วมือ",
  "quantcode.ssh.groups": "กลุ่มที่ผูกไว้",
  "quantcode.ssh.groupSuffix": "กลุ่ม",
  "quantcode.ssh.disconnect": "ตัดการเชื่อมต่อ",
  "quantcode.ssh.failed": "การเชื่อมต่อล้มเหลว",
  "quantcode.ssh.retry": "ลองอีกครั้ง",
  "quantcode.ssh.reason.key_rejected": "คีย์ถูกปฏิเสธ",
  "quantcode.ssh.reason.host_unreachable": "ไม่สามารถเข้าถึงโฮสต์ได้",
  "quantcode.ssh.reason.unavailable": "บริการเชื่อมต่อ SSH ยังไม่พร้อม",

  "quantcode.capability.title": "แคตตาล็อกความสามารถ",
  "quantcode.capability.intro": "ความสามารถการวิจัยที่ลงทะเบียนขององค์กร ตรวจสอบที่นี่ก่อนร่างแนวทางแก้ — ใช้ซ้ำ อย่าสร้างใหม่",
  "quantcode.capability.searchPlaceholder": "ค้นหาความสามารถ พื้นที่ API หรือกรณีใช้งาน…",
  "quantcode.capability.ownerGroup": "กลุ่มเจ้าของ",
  "quantcode.capability.whenToUse": "ใช้เมื่อใด",
  "quantcode.capability.whenNotToReinvent": "อย่าสร้างใหม่เมื่อใด",
  "quantcode.capability.apiSurface": "พื้นที่ API",
  "quantcode.capability.source": "แหล่งที่มา",
  "quantcode.capability.noMatch": "ไม่มีการ์ดความสามารถที่ตรงกัน",
  "quantcode.capability.empty": "ช่องทางแคตตาล็อกยังไม่เชื่อมต่อ: รอเมตาเครื่องมือ list_capabilities (ผ่าน run trace หรือ fetcher ที่ฉีดเข้ามา)",
  "quantcode.memory.title": "ค้นหา Memory",
  "quantcode.memory.intro": "ค้นหา Memory ในกลุ่มและที่แชร์ (อ่านอย่างเดียว ข้ามกลุ่ม fail-closed)",
  "quantcode.memory.searchPlaceholder": "ค้นหาความจำการวิจัย…",
  "quantcode.memory.search": "ค้นหา",
  "quantcode.memory.empty": "พิมพ์คำสำคัญเพื่อสืบค้น Memory",
  "quantcode.memory.noResults": "ไม่มีรายการความจำที่ตรงกัน",
  "quantcode.memory.denied": "ไม่มีสิทธิ์: การอ่าน Memory ข้ามกลุ่มถูกปฏิเสธ (fail-closed)",
  "quantcode.memory.unavailable": "ช่องทาง Memory ยังไม่เชื่อมต่อ: รอเครื่องมือ memory_search (ฉีด fetcher ได้)",
  "quantcode.memory.score": "ความเกี่ยวข้อง",
  "quantcode.solution.title": "แผงแนวทางแก้",
  "quantcode.solution.empty": "ยังไม่มีแนวทางแก้ในเซสชันนี้ ใช้ /solution <เป้าหมาย> เพื่อเริ่มโฟลว์แนวทางแก้ก่อน",
  "quantcode.solution.draft": "แนวทางแก้ยังไม่ถูกตรึง",
  "quantcode.solution.draftHint": "แนวทางแก้ยังไม่ถูกตรึง — เครื่องมือโค้ดใช้ไม่ได้ โปรดหารือและตรึงก่อน (แก้จุดเดียวแบบ trivial ยกเว้นได้)",
  "quantcode.solution.frozen": "ตรึงแล้ว",
  "quantcode.solution.rounds": "รอบการหารือ",
  "quantcode.solution.revision": "การแก้ไข",
  "quantcode.solution.docHash": "ท้าย doc_hash",
  "quantcode.solution.solutionId": "รหัสแนวทางแก้",
  "quantcode.solution.verdict.conformant": "การนำไปใช้สอดคล้องกับแนวทางแก้",
  "quantcode.solution.verdict.deviation": "ตรวจพบการเบี่ยงเบน",
  "quantcode.solution.verdict.needs_human": "ต้องการการตัดสินของมนุษย์",
  "quantcode.solution.deviatedFiles": "รายการไฟล์ที่เบี่ยงเบน",
  "quantcode.cmd.solution.title": "เริ่มแนวทางแก้ (P-10)",
  "quantcode.cmd.solution.description": "เติมคำสั่งเปิด draft_solution ล่วงหน้า; เครื่องมือโค้ดยังใช้ไม่ได้จนกว่าจะตรึง",
  "quantcode.cmd.solution.template": "เป้าหมายการวิจัย:\n<อธิบายเป้าหมายที่นี่>\n\nคุณต้องเรียกเครื่องมือ draft_solution ทันที (goal: เป้าหมายด้านบน) ห้ามตอบเป็นข้อความ เครื่องมือโค้ดจะใช้ไม่ได้จนกว่าจะ freeze_solution — อย่าเริ่มนำไปใช้",
  "quantcode.cmd.deploy.title": "ดีพลอยกล่องดำ (P-09)",
  "quantcode.cmd.deploy.description": "เติมคำสั่งเรียก deploy_alphaflow ล่วงหน้า; การดีพลอยต้องได้รับอนุมัติ kind=deploy",
  "quantcode.cmd.deploy.template": "ซอร์สโค้ดที่จะดีพลอย:\n<เส้นทางหรือคำอธิบายที่นี่>\n\nคุณต้องเรียกเครื่องมือ deploy_alphaflow ทันที (source: ข้อความด้านบน) ห้ามตอบเป็นข้อความ รายงานเพียงความสำเร็จ/ล้มเหลวของการปรับและเส้นทาง artifact — ห้ามเปิดเผยโครงสร้างภายในของ AlphaFlow เด็ดขาด",
  "quantcode.admin.title": "คอนโซลผู้ดูแล",
  "quantcode.admin.intro": "สอบถามสถานะองค์กรด้วยภาษาธรรมชาติ; ผลลัพธ์จากเมตาเครื่องมือ admin_* จะไหลกลับมาที่นี่ จัดกลุ่มตาม กลุ่ม → สมาชิก → สถานะ",
  "quantcode.admin.inputPlaceholder": "ถาม: งานล่าสุดของแต่ละกลุ่ม / สถานะโมดูล / บันทึกข้อผิดพลาด…",
  "quantcode.admin.send": "ส่งคำถาม",
  "quantcode.admin.presetRuns": "งานล่าสุดของแต่ละกลุ่ม",
  "quantcode.admin.presetModules": "สถานะโมดูล",
  "quantcode.admin.presetErrors": "บันทึกข้อผิดพลาดของแต่ละกลุ่ม",
  "quantcode.admin.sent": "ส่งคำถามแล้ว; ผลลัพธ์จะปรากฏเมื่อเครื่องมือ admin_* ตอบกลับ",
  "quantcode.admin.waiting": "กำลังรอผลลัพธ์ admin_*…",
  "quantcode.admin.emptyTitle": "ช่องทางข้อมูลยังไม่เชื่อมต่อ",
  "quantcode.admin.empty": "หลังส่งคำถาม ผลลัพธ์ของ admin_list_runs / admin_errors จะมาที่นี่ ใช้เฉพาะข้อมูลจริง ไม่มีข้อมูลปลอม",
  "quantcode.admin.errorsEmpty": "ไม่มีข้อผิดพลาดที่บันทึกไว้; ทุกกลุ่มทำงานปกติ",
  "quantcode.admin.filterAll": "ทั้งหมด",
  "quantcode.admin.reportsEntry": "รายงาน",
  "quantcode.admin.tasksEntry": "งาน",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "มุมมอง GitGraph ทุกที่เก็บ",
  "quantcode.gitgraph.intro": "สถานะล่าสุดของแผนผังทุกที่เก็บ: โหนดที่มี push ภายใน 7 วันจะถูกไฮไลต์สีแดงและอยู่ด้านบน; กรองตามกลุ่มได้",
  "quantcode.gitgraph.check": "ตรวจสอบการอัปเดต",
  "quantcode.gitgraph.checked": "ตรวจล่าสุด",
  "quantcode.gitgraph.emptyTitle": "ช่องทางข้อมูลยังไม่เชื่อมต่อ",
  "quantcode.gitgraph.empty": "คลิก «ตรวจสอบการอัปเดต» ผลลัพธ์ของ admin_repo_status / admin_package_updates จะมาที่นี่ ใช้เฉพาะข้อมูลจริง",
  "quantcode.gitgraph.waiting": "กำลังรอผลลัพธ์ admin_repo_status…",
  "quantcode.gitgraph.updated": "มีการอัปเดต",
  "quantcode.gitgraph.packagesEmpty": "แพ็กเกจทั้งหมดเป็นเวอร์ชันล่าสุด",
  "quantcode.gitgraph.package": "แพ็กเกจ",
  "quantcode.gitgraph.open": "เปิด GitGraph",
  "quantcode.pop.repoTitle": "ที่เก็บมีคอมมิตใหม่",
  "quantcode.pop.packageTitle": "มีการอัปเดตแพ็กเกจ",
  "quantcode.pop.viewGitgraph": "ดู GitGraph",
}
