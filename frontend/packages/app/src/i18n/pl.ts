export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Generowane automatycznie na podstawie nazwy wyświetlanej. Możesz to edytować.",
  ...
  "provider.custom.action.fetchModels": "Pobierz modele",
  "provider.custom.status.fetching": "Pobieranie modeli…",
  "provider.custom.error.fetchFailed": "Nie udało się pobrać modeli. Dodaj je ręcznie.",
  "provider.custom.hint.apiKeyEnv": "Pobieranie jest niedostępne, gdy klucz API używa składni {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Połącz dostawcę zewnętrznego, aby zacząć korzystać z modeli.",
  "sidebar.gettingStarted.line2": "Wystarczy podstawowy URL i klucz API.",
  ...
  "settings.providers.add.thirdParty": "Dodaj dostawcę zewnętrznego",
  ...
  "quantcode.ssh.user": "Użytkownik",
  "quantcode.ssh.privateKey": "Klucz prywatny",
  "quantcode.ssh.privateKeyHint": "Klucz prywatny jest przekazywany do backendu tylko w pamięci — nigdy nie jest zapisywany ani wyświetlany.",
  "quantcode.ssh.connect": "Połącz",
  "quantcode.ssh.connecting": "Łączenie…",
  "quantcode.ssh.logWaiting": "Oczekiwanie na odpowiedź serwera…",
  "quantcode.ssh.connected": "Połączono",
  "quantcode.ssh.fingerprint": "Odcisk klucza",
  "quantcode.ssh.groups": "Powiązane grupy",
  "quantcode.ssh.groupSuffix": "grupa",
  "quantcode.ssh.disconnect": "Rozłącz",
  "quantcode.ssh.failed": "Połączenie nie powiodło się",
  "quantcode.ssh.retry": "Ponów",
  "quantcode.ssh.reason.key_rejected": "Klucz odrzucony",
  "quantcode.ssh.reason.host_unreachable": "Host nieosiągalny",
  "quantcode.ssh.reason.unavailable": "Usługa połączenia SSH nie jest jeszcze gotowa",

  "quantcode.capability.title": "Katalog zdolności",
  "quantcode.capability.intro": "Zarejestrowane zdolności organizacji. Sprawdź tutaj przed tworzeniem rozwiązania — wykorzystaj ponownie, nie wynajduj od nowa.",
  "quantcode.capability.searchPlaceholder": "Szukaj zdolności, powierzchni API lub zastosowań…",
  "quantcode.capability.ownerGroup": "Grupa właścicielska",
  "quantcode.capability.whenToUse": "Kiedy używać",
  "quantcode.capability.whenNotToReinvent": "Kiedy nie wymyślać na nowo",
  "quantcode.capability.apiSurface": "Powierzchnia API",
  "quantcode.capability.source": "źródło",
  "quantcode.capability.noMatch": "Brak pasujących kart zdolności.",
  "quantcode.capability.empty": "Katalog jeszcze nie połączony: oczekiwanie na narzędzie list_capabilities (przez run trace lub wstrzyknięty fetcher).",
  "quantcode.memory.title": "Zapytanie Memory",
  "quantcode.memory.intro": "Wyszukiwanie w Memory grupy i współdzielonym (tylko odczyt, międzygrupowe fail-closed).",
  "quantcode.memory.searchPlaceholder": "Szukaj w pamięci badawczej…",
  "quantcode.memory.search": "Szukaj",
  "quantcode.memory.empty": "Wpisz słowa kluczowe, aby zapytać Memory.",
  "quantcode.memory.noResults": "Brak pasujących wpisów pamięci.",
  "quantcode.memory.denied": "Brak uprawnień: międzygrupowy odczyt Memory odrzucony (fail-closed).",
  "quantcode.memory.unavailable": "Kanał Memory jeszcze nie połączony: oczekiwanie na narzędzie memory_search (fetcher do wstrzyknięcia).",
  "quantcode.memory.score": "Trafność",
  "quantcode.solution.title": "Panel rozwiązania",
  "quantcode.solution.empty": "W tej sesji nie ma jeszcze rozwiązania. Użyj /solution <cel>, aby rozpocząć tryb „najpierw rozwiązanie”.",
  "quantcode.solution.draft": "Rozwiązanie nie zamrożone",
  "quantcode.solution.draftHint": "Rozwiązanie nie zamrożone — narzędzia kodu niedostępne. Najpierw przedyskutuj i zamroź (trywialne poprawki punktowe są wyłączone).",
  "quantcode.solution.frozen": "Zamrożone",
  "quantcode.solution.rounds": "Rundy dyskusji",
  "quantcode.solution.revision": "Rewizja",
  "quantcode.solution.docHash": "końcówka doc_hash",
  "quantcode.solution.solutionId": "ID rozwiązania",
  "quantcode.solution.verdict.conformant": "Implementacja zgodna z rozwiązaniem",
  "quantcode.solution.verdict.deviation": "Wykryto odstępstwo",
  "quantcode.solution.verdict.needs_human": "Wymaga decyzji człowieka",
  "quantcode.solution.deviatedFiles": "Lista odstających plików",
  "quantcode.cmd.solution.title": "Rozpocznij rozwiązanie (P-10)",
  "quantcode.cmd.solution.description": "Prefill aktywacji draft_solution; narzędzia kodu zablokowane do zamrożenia",
  "quantcode.cmd.solution.template": "Cel badania:\n<Opisz tu cel>\n\nMUSISZ teraz wywołać narzędzie draft_solution (goal: cel powyżej). Nie odpowiadaj tekstem. Narzędzia kodu są niedostępne do freeze_solution — nie zaczynaj implementacji.",
  "quantcode.cmd.deploy.title": "Wdrożenie czarna skrzynka (P-09)",
  "quantcode.cmd.deploy.description": "Prefill wywołania deploy_alphaflow; wdrożenie wymaga zatwierdzenia kind=deploy",
  "quantcode.cmd.deploy.template": "Źródło kodu do wdrożenia:\n<Ścieżka lub opis tutaj>\n\nMUSISZ teraz wywołać narzędzie deploy_alphaflow (source: tekst powyżej). Nie odpowiadaj tekstem. Raportuj tylko sukces/porażkę adaptacji i ścieżkę artefaktu — nigdy nie ujawniaj wewnętrznej struktury AlphaFlow.",
  "quantcode.admin.title": "Konsola Admin",
  "quantcode.admin.intro": "Odpytuj stan organizacji językiem naturalnym; wyniki meta-narzędzi admin_* wracają tutaj, pogrupowane wg grupy → osoby → statusu.",
  "quantcode.admin.inputPlaceholder": "Zapytaj: ostatnia praca grup / stan modułów / dzienniki błędów…",
  "quantcode.admin.send": "Wyślij zapytanie",
  "quantcode.admin.presetRuns": "Ostatnia praca grup",
  "quantcode.admin.presetModules": "Stan modułów",
  "quantcode.admin.presetErrors": "Dzienniki błędów grup",
  "quantcode.admin.sent": "Zapytanie wysłane; wyniki pojawią się, gdy odpowiadą narzędzia admin_*.",
  "quantcode.admin.waiting": "Oczekiwanie na wyniki admin_*…",
  "quantcode.admin.emptyTitle": "Kanał danych nie został jeszcze podłączony",
  "quantcode.admin.empty": "Po wysłaniu zapytania wyniki admin_list_runs / admin_errors trafią tutaj. Wyłącznie prawdziwe dane — bez zmyślenia.",
  "quantcode.admin.errorsEmpty": "Brak zapisanych błędów; wszystkie grupy działają normalnie.",
  "quantcode.admin.filterAll": "Wszystko",
  "quantcode.admin.reportsEntry": "Raporty",
  "quantcode.admin.tasksEntry": "Zadania",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "Widok GitGraph wszystkich repozytoriów",
  "quantcode.gitgraph.intro": "Najnowszy stan drzewa wszystkich repozytoriów: węzły z pushem w ciągu 7 dni są podświetlone na czerwono i na górze; filtr wg grupy.",
  "quantcode.gitgraph.check": "Sprawdź aktualizacje",
  "quantcode.gitgraph.checked": "Ostatnie sprawdzenie",
  "quantcode.gitgraph.emptyTitle": "Kanał danych nie został jeszcze podłączony",
  "quantcode.gitgraph.empty": "Kliknij „Sprawdź aktualizacje” — wyniki admin_repo_status / admin_package_updates trafią tutaj. Wyłącznie prawdziwe dane.",
  "quantcode.gitgraph.waiting": "Oczekiwanie na wyniki admin_repo_status…",
  "quantcode.gitgraph.updated": "Zaktualizowano",
  "quantcode.gitgraph.packagesEmpty": "Wszystkie zależności są aktualne.",
  "quantcode.gitgraph.package": "zależność",
  "quantcode.gitgraph.open": "Otwórz GitGraph",
  "quantcode.pop.repoTitle": "Repozytorium ma nowe commity",
  "quantcode.pop.packageTitle": "Dostępna aktualizacja zależności",
  "quantcode.pop.viewGitgraph": "Otwórz GitGraph",
}
