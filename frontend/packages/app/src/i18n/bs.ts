export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Automatski generisano iz imena za prikaz. Možete ga urediti.",
  ...
  "provider.custom.action.fetchModels": "Preuzmi modele",
  "provider.custom.status.fetching": "Preuzimanje modela…",
  "provider.custom.error.fetchFailed": "Preuzimanje modela nije uspjelo. Dodajte ih ručno.",
  "provider.custom.hint.apiKeyEnv": "Preuzimanje nije dostupno dok API ključ koristi sintaksu {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Poveži provajdera treće strane da počneš koristiti modele.",
  "sidebar.gettingStarted.line2": "Potrebni su ti samo bazni URL i API ključ.",
  ...
  "settings.providers.add.thirdParty": "Dodaj provajdera treće strane",
  ...
  "quantcode.ssh.user": "Korisnik",
  "quantcode.ssh.privateKey": "Privatni ključ",
  "quantcode.ssh.privateKeyHint": "Privatni ključ se prosljeđuje backendu samo u memoriji — nikada se ne čuva ni ne prikazuje.",
  "quantcode.ssh.connect": "Poveži se",
  "quantcode.ssh.connecting": "Povezivanje…",
  "quantcode.ssh.logWaiting": "Čekanje odgovora servera…",
  "quantcode.ssh.connected": "Povezano",
  "quantcode.ssh.fingerprint": "Otisak ključa",
  "quantcode.ssh.groups": "Vezane grupe",
  "quantcode.ssh.groupSuffix": "grupa",
  "quantcode.ssh.disconnect": "Prekini vezu",
  "quantcode.ssh.failed": "Povezivanje nije uspjelo",
  "quantcode.ssh.retry": "Pokušaj ponovo",
  "quantcode.ssh.reason.key_rejected": "Ključ je odbijen",
  "quantcode.ssh.reason.host_unreachable": "Host nedostupan",
  "quantcode.ssh.reason.unavailable": "SSH usluga povezivanja još nije spremna",

  "quantcode.capability.title": "Katalog sposobnosti",
  "quantcode.capability.intro": "Registrovane istraživačke sposobnosti organizacije. Provjeri ovdje prije izrade rješenja — ponovo koristi, ne izmišljaj.",
  "quantcode.capability.searchPlaceholder": "Pretraži sposobnosti, API površine ili namjene…",
  "quantcode.capability.ownerGroup": "Vlasnička grupa",
  "quantcode.capability.whenToUse": "Kada koristiti",
  "quantcode.capability.whenNotToReinvent": "Kada ne izmišljati ispočetka",
  "quantcode.capability.apiSurface": "API površina",
  "quantcode.capability.source": "izvor",
  "quantcode.capability.noMatch": "Nema odgovarajućih kartica sposobnosti.",
  "quantcode.capability.empty": "Katalog još nije povezan: čeka se meta-alat list_capabilities (preko run trace-a ili ubačenog fetcher-a).",
  "quantcode.memory.title": "Memory upit",
  "quantcode.memory.intro": "Pretraži grupni i dijeljeni Memory (samo za čitanje, međugrupno fail-closed).",
  "quantcode.memory.searchPlaceholder": "Pretraži istraživačku memoriju…",
  "quantcode.memory.search": "Pretraži",
  "quantcode.memory.empty": "Unesite ključne riječi za upit nad Memory.",
  "quantcode.memory.noResults": "Nema odgovarajućih zapisa memorije.",
  "quantcode.memory.denied": "Nema dozvole: međugrupno čitanje Memory odbijeno (fail-closed).",
  "quantcode.memory.unavailable": "Memory kanal još nije povezan: čeka se alat memory_search (moguće ubaciti fetcher).",
  "quantcode.memory.score": "Relevantnost",
  "quantcode.solution.title": "Panel rješenja",
  "quantcode.solution.empty": "Još nema rješenja u ovoj sesiji. Koristite /solution <cilj> za pokretanje toka „prvo rješenje“.",
  "quantcode.solution.draft": "Rješenje nije zamrznuto",
  "quantcode.solution.draftHint": "Rješenje nije zamrznuto — alati za kod nedostupni. Prvo diskutujte i zamrznite (trivijalne ispravke jedne tačke su izuzete).",
  "quantcode.solution.frozen": "Zamrznuto",
  "quantcode.solution.rounds": "Runde diskusije",
  "quantcode.solution.revision": "Revizija",
  "quantcode.solution.docHash": "kraj doc_hash-a",
  "quantcode.solution.solutionId": "ID rješenja",
  "quantcode.solution.verdict.conformant": "Implementacija odgovara rješenju",
  "quantcode.solution.verdict.deviation": "Otkriveno odstupanje",
  "quantcode.solution.verdict.needs_human": "Potrebna ljudska odluka",
  "quantcode.solution.deviatedFiles": "Popis odstupajućih datoteka",
  "quantcode.cmd.solution.title": "Pokreni rješenje (P-10)",
  "quantcode.cmd.solution.description": "Prefill aktivacije draft_solution; alati za kod ostaju zaključani do zamrzavanja",
  "quantcode.cmd.solution.template": "Cilj istraživanja:\n<Ovdje opišite cilj>\n\nMORAŠ odmah pozvati alat draft_solution (goal: cilj iznad). Ne odgovaraj tekstom. Alati za kod ostaju nedostupni do freeze_solution — ne počinji implementaciju.",
  "quantcode.cmd.deploy.title": "Deploy crna kutija (P-09)",
  "quantcode.cmd.deploy.description": "Prefill poziva deploy_alphaflow; deploy zahtijeva kind=deploy odobrenje",
  "quantcode.cmd.deploy.template": "Izvor koda za deploy:\n<Putanja ili opis ovdje>\n\nMORAŠ odmah pozvati alat deploy_alphaflow (source: tekst iznad). Ne odgovaraj tekstom. Prijavi samo uspjeh/neuspjeh prilagođavanja i putanju artefakta — nikad ne otkrivaj unutrašnju strukturu AlphaFlow-a.",
  "quantcode.admin.title": "Admin konzola",
  "quantcode.admin.intro": "Stanje organizacije pitajte prirodnim jezikom; rezultati admin_* meta-alata vraćaju se ovdje, grupisano po grupi → osobi → statusu.",
  "quantcode.admin.inputPlaceholder": "Pitajte: nedavni rad po grupama / status modula / evidencije grešaka…",
  "quantcode.admin.send": "Pošalji upit",
  "quantcode.admin.presetRuns": "Nedavni rad po grupama",
  "quantcode.admin.presetModules": "Status modula",
  "quantcode.admin.presetErrors": "Evidencije grešaka po grupama",
  "quantcode.admin.sent": "Upit poslan; rezultati će se pojaviti kad se admin_* alati vrate.",
  "quantcode.admin.waiting": "Čekanje na admin_* rezultate…",
  "quantcode.admin.emptyTitle": "Kanal podataka još nije povezan",
  "quantcode.admin.empty": "Nakon slanja, rezultati admin_list_runs / admin_errors stižu ovdje. Samo stvarni podaci — bez izmišljanja.",
  "quantcode.admin.errorsEmpty": "Nema zabilježenih grešaka; sve grupe rade normalno.",
  "quantcode.admin.filterAll": "Sve",
  "quantcode.admin.reportsEntry": "Izvještaji",
  "quantcode.admin.tasksEntry": "Zadaci",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph prikaz svih repozitorija",
  "quantcode.gitgraph.intro": "Najnovije stanje stabla svih repozitorija: čvorovi s pushom u posljednjih 7 dana istaknuti su crveno i na vrhu; filtriranje po grupi.",
  "quantcode.gitgraph.check": "Provjeri ažuriranja",
  "quantcode.gitgraph.checked": "Posljednja provjera",
  "quantcode.gitgraph.emptyTitle": "Kanal podataka još nije povezan",
  "quantcode.gitgraph.empty": "Kliknite „Provjeri ažuriranja”; rezultati admin_repo_status / admin_package_updates stižu ovdje. Samo stvarni podaci.",
  "quantcode.gitgraph.waiting": "Čekanje na admin_repo_status rezultate…",
  "quantcode.gitgraph.updated": "Ima ažuriranja",
  "quantcode.gitgraph.packagesEmpty": "Sve zavisnosti su aktualne.",
  "quantcode.gitgraph.package": "zavisnost",
  "quantcode.gitgraph.open": "Otvori GitGraph",
  "quantcode.pop.repoTitle": "Repozitorij ima nove commitove",
  "quantcode.pop.packageTitle": "Dostupno ažuriranje zavisnosti",
  "quantcode.pop.viewGitgraph": "Otvori GitGraph",
}
