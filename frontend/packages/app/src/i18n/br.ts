export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Gerado automaticamente a partir do nome de exibição. Você pode editá-lo.",
  ...
  "provider.custom.action.fetchModels": "Buscar modelos",
  "provider.custom.status.fetching": "Buscando modelos…",
  "provider.custom.error.fetchFailed": "Falha ao buscar modelos. Adicione-os manualmente.",
  "provider.custom.hint.apiKeyEnv": "A busca fica indisponível enquanto a chave de API usa a sintaxe {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Conecte um provedor de terceiros para começar a usar modelos.",
  "sidebar.gettingStarted.line2": "Você só precisa de uma URL base e de uma chave de API.",
  ...
  "settings.providers.add.thirdParty": "Adicionar provedor de terceiros",
  ...
  "quantcode.ssh.user": "Usuário",
  "quantcode.ssh.privateKey": "Chave privada",
  "quantcode.ssh.privateKeyHint": "A chave privada é passada ao backend apenas em memória — nunca é armazenada nem exibida.",
  "quantcode.ssh.connect": "Conectar",
  "quantcode.ssh.connecting": "Conectando…",
  "quantcode.ssh.logWaiting": "Aguardando resposta do servidor…",
  "quantcode.ssh.connected": "Conectado",
  "quantcode.ssh.fingerprint": "Impressão digital",
  "quantcode.ssh.groups": "Grupos vinculados",
  "quantcode.ssh.groupSuffix": "grupo",
  "quantcode.ssh.disconnect": "Desconectar",
  "quantcode.ssh.failed": "Falha na conexão",
  "quantcode.ssh.retry": "Tentar novamente",
  "quantcode.ssh.reason.key_rejected": "Chave rejeitada",
  "quantcode.ssh.reason.host_unreachable": "Host inacessível",
  "quantcode.ssh.reason.unavailable": "O serviço de conexão SSH ainda não está pronto",

  "quantcode.capability.title": "Catálogo de capacidades",
  "quantcode.capability.intro": "Capacidades de pesquisa registradas pela organização. Consulte aqui antes de redigir uma solução — reutilize, não reinvente.",
  "quantcode.capability.searchPlaceholder": "Buscar capacidades, superfícies de API ou usos…",
  "quantcode.capability.ownerGroup": "Grupo responsável",
  "quantcode.capability.whenToUse": "Quando usar",
  "quantcode.capability.whenNotToReinvent": "Quando não reinventar",
  "quantcode.capability.apiSurface": "Superfície de API",
  "quantcode.capability.source": "fonte",
  "quantcode.capability.noMatch": "Nenhum cartão de capacidade correspondente.",
  "quantcode.capability.empty": "Catálogo ainda não conectado: aguardando a meta-ferramenta list_capabilities (via run trace ou fetcher injetado).",
  "quantcode.memory.title": "Consulta Memory",
  "quantcode.memory.intro": "Pesquisar o Memory do grupo e compartilhado (somente leitura, entre grupos fail-closed).",
  "quantcode.memory.searchPlaceholder": "Pesquisar na memória de pesquisa…",
  "quantcode.memory.search": "Buscar",
  "quantcode.memory.empty": "Digite palavras-chave para consultar o Memory.",
  "quantcode.memory.noResults": "Nenhuma entrada de memória correspondente.",
  "quantcode.memory.denied": "Sem permissão: leitura entre grupos do Memory negada (fail-closed).",
  "quantcode.memory.unavailable": "Canal do Memory ainda não conectado: aguardando a ferramenta memory_search (fetcher injetável).",
  "quantcode.memory.score": "Relevância",
  "quantcode.solution.title": "Painel de solução",
  "quantcode.solution.empty": "Ainda não há solução nesta sessão. Use /solution <objetivo> para iniciar o fluxo de solução primeiro.",
  "quantcode.solution.draft": "Solução não congelada",
  "quantcode.solution.draftHint": "Solução não congelada — ferramentas de código indisponíveis. Discuta e congele primeiro (correções triviais pontuais são isentas).",
  "quantcode.solution.frozen": "Congelada",
  "quantcode.solution.rounds": "Rodadas de discussão",
  "quantcode.solution.revision": "Revisão",
  "quantcode.solution.docHash": "final do doc_hash",
  "quantcode.solution.solutionId": "ID da solução",
  "quantcode.solution.verdict.conformant": "A implementação corresponde à solução",
  "quantcode.solution.verdict.deviation": "Desvio detectado",
  "quantcode.solution.verdict.needs_human": "Requer decisão humana",
  "quantcode.solution.deviatedFiles": "Arquivos em desvio",
  "quantcode.cmd.solution.title": "Iniciar solução (P-10)",
  "quantcode.cmd.solution.description": "Pré-preenche a ativação do draft_solution; ferramentas de código seguem bloqueadas até congelar",
  "quantcode.cmd.solution.template": "Objetivo de pesquisa:\n<Descreva aqui o objetivo>\n\nVocê DEVE chamar a ferramenta draft_solution agora (goal: o objetivo acima). Não responda com texto. As ferramentas de código ficam indisponíveis até o freeze_solution — não comece a implementar.",
  "quantcode.cmd.deploy.title": "Deploy caixa-preta (P-09)",
  "quantcode.cmd.deploy.description": "Pré-preenche a chamada deploy_alphaflow; o deploy exige aprovação kind=deploy",
  "quantcode.cmd.deploy.template": "Fonte de código a implantar:\n<Caminho ou descrição aqui>\n\nVocê DEVE chamar a ferramenta deploy_alphaflow agora (source: o texto acima). Não responda com texto. Informe apenas sucesso/falha de adaptação e o caminho do artifact — nunca revele a estrutura interna do AlphaFlow.",
  "quantcode.admin.title": "Console Admin",
  "quantcode.admin.intro": "Consulte o status da organização em linguagem natural; os resultados das metaferramentas admin_* retornam aqui, agrupados por grupo → pessoa → status.",
  "quantcode.admin.inputPlaceholder": "Perguntar: trabalho recente por grupo / status dos módulos / registros de erros…",
  "quantcode.admin.send": "Enviar consulta",
  "quantcode.admin.presetRuns": "Trabalho recente por grupo",
  "quantcode.admin.presetModules": "Status dos módulos",
  "quantcode.admin.presetErrors": "Registros de erros por grupo",
  "quantcode.admin.sent": "Consulta enviada; os resultados aparecerão quando as ferramentas admin_* responderem.",
  "quantcode.admin.waiting": "Aguardando resultados de admin_*…",
  "quantcode.admin.emptyTitle": "Canal de dados ainda não conectado",
  "quantcode.admin.empty": "Após enviar a consulta, os resultados de admin_list_runs / admin_errors chegarão aqui. Somente dados reais — nada inventado.",
  "quantcode.admin.errorsEmpty": "Nenhum erro registrado; todos os grupos operam normalmente.",
  "quantcode.admin.filterAll": "Todos",
  "quantcode.admin.reportsEntry": "Relatórios",
  "quantcode.admin.tasksEntry": "Tarefas",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "Visão GitGraph de todos os repos",
  "quantcode.gitgraph.intro": "Estado mais recente da árvore de todos os repos: nós com push nos últimos 7 dias ficam em vermelho no topo; filtrável por grupo.",
  "quantcode.gitgraph.check": "Verificar atualizações",
  "quantcode.gitgraph.checked": "Última verificação",
  "quantcode.gitgraph.emptyTitle": "Canal de dados ainda não conectado",
  "quantcode.gitgraph.empty": "Clique em «Verificar atualizações»; os resultados de admin_repo_status / admin_package_updates chegarão aqui. Somente dados reais.",
  "quantcode.gitgraph.waiting": "Aguardando resultados de admin_repo_status…",
  "quantcode.gitgraph.updated": "Atualizado",
  "quantcode.gitgraph.packagesEmpty": "Todas as dependências estão atualizadas.",
  "quantcode.gitgraph.package": "dependência",
  "quantcode.gitgraph.open": "Abrir GitGraph",
  "quantcode.pop.repoTitle": "O repo tem novos commits",
  "quantcode.pop.packageTitle": "Atualização de dependência disponível",
