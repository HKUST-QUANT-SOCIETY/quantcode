...
export const dict = {
  ...
  "provider.custom.field.providerID.auto": "根據顯示名稱自動產生，可手動修改。",
  ...
  "provider.custom.action.fetchModels": "取得模型清單",
  "provider.custom.status.fetching": "取得模型清單中…",
  "provider.custom.error.fetchFailed": "取得模型清單失敗，請手動新增。",
  "provider.custom.hint.apiKeyEnv": "API 金鑰使用 {env:VAR} 語法時無法取得模型清單。",
  ...
  "sidebar.gettingStarted.line1": "綁定一個第三方供應商即可開始使用模型。",
  "sidebar.gettingStarted.line2": "只需填寫基礎 URL 和 API 金鑰。",
  ...
  "settings.providers.add.thirdParty": "新增第三方供應商",
  ...
  "quantcode.ssh.host": "主機",
  "quantcode.ssh.user": "使用者名稱",
  "quantcode.ssh.privateKey": "私鑰",
  "quantcode.ssh.privateKeyHint": "私鑰僅在記憶體中傳給後端，不會儲存或回顯。",
  "quantcode.ssh.connect": "連線",
  "quantcode.ssh.connecting": "連線中…",
  "quantcode.ssh.logWaiting": "等待伺服器回應…",
  "quantcode.ssh.connected": "已連線",
  "quantcode.ssh.fingerprint": "指紋",
  "quantcode.ssh.groups": "群組綁定",
  "quantcode.ssh.groupSuffix": "組",
  "quantcode.ssh.disconnect": "斷線",
  "quantcode.ssh.failed": "連線失敗",
  "quantcode.ssh.retry": "重試",
  "quantcode.ssh.reason.key_rejected": "金鑰被拒",
  "quantcode.ssh.reason.host_unreachable": "主機無法連線",
  "quantcode.ssh.reason.unavailable": "SSH 連線服務尚未就緒",

  "quantcode.capability.title": "能力目錄",
  "quantcode.capability.intro": "組織已登記的研究能力。方案制定前先查這裡——能複用就別自造。",
  "quantcode.capability.searchPlaceholder": "搜尋能力、介面面或用途…",
  "quantcode.capability.ownerGroup": "屬組",
  "quantcode.capability.whenToUse": "何時用",
  "quantcode.capability.whenNotToReinvent": "何時別自造",
  "quantcode.capability.apiSurface": "介面面",
  "quantcode.capability.source": "來源",
  "quantcode.capability.noMatch": "沒有匹配的能力卡片。",
  "quantcode.capability.empty": "能力目錄通道尚未接通：等待後端 list_capabilities 元工具（經 run trace 或注入 fetcher）。",
  "quantcode.memory.title": "Memory 查詢",
  "quantcode.memory.intro": "檢索組內與共享 Memory（唯讀，跨組 fail-closed）。",
  "quantcode.memory.searchPlaceholder": "搜尋研究記憶…",
  "quantcode.memory.search": "搜尋",
  "quantcode.memory.empty": "輸入關鍵詞查詢 Memory。",
  "quantcode.memory.noResults": "沒有匹配的記憶條目。",
  "quantcode.memory.denied": "無權限：跨組 Memory 讀取被拒絕（fail-closed）。",
  "quantcode.memory.unavailable": "Memory 檢索通道尚未接通：等待後端 memory_search 工具（可注入 fetcher）。",
  "quantcode.memory.score": "相關度",
  "quantcode.solution.title": "方案面板",
  "quantcode.solution.empty": "本會話還沒有方案。使用 /solution <目標> 發起方案先行流程。",
  "quantcode.solution.draft": "方案未凍結",
  "quantcode.solution.draftHint": "方案未凍結，程式碼工具不可用——請先討論並凍結方案（trivial 單點修復可豁免）。",
  "quantcode.solution.frozen": "已凍結",
  "quantcode.solution.rounds": "討論輪次",
  "quantcode.solution.revision": "修訂",
  "quantcode.solution.docHash": "doc_hash 尾號",
  "quantcode.solution.solutionId": "方案 ID",
  "quantcode.solution.verdict.conformant": "實現符合方案",
  "quantcode.solution.verdict.deviation": "存在偏離",
  "quantcode.solution.verdict.needs_human": "需人工裁決",
  "quantcode.solution.deviatedFiles": "偏離檔案清單",
  "quantcode.cmd.solution.title": "發起方案（P-10）",
  "quantcode.cmd.solution.description": "預填 draft_solution 啟動指令；方案凍結前程式碼工具不可用",
  "quantcode.cmd.solution.template": "研究目標：\n<在此描述要解決的研究目標>\n\n你現在必須呼叫 draft_solution 工具（goal 用上面的目標），不要回覆文字。方案凍結（freeze_solution）之前程式碼工具不可用，不要開始實現。",
  "quantcode.cmd.deploy.title": "黑盒部署（P-09）",
  "quantcode.cmd.deploy.description": "預填 deploy_alphaflow 呼叫指令；部署需 kind=deploy 審批，結果不透露內部結構",
  "quantcode.cmd.deploy.template": "要部署的程式碼來源：\n<在此給出程式碼路徑或描述>\n\n你現在必須呼叫 deploy_alphaflow 工具（source 用上面的內容），不要回覆文字。結果只報告適配成敗與 artifact 路徑，不得透露 AlphaFlow 內部結構。",
  "quantcode.admin.title": "Admin 中樞",
  "quantcode.admin.intro": "語義查詢台：用自然語言詢問組織運行狀態，Agent 調用 admin_* 元工具後，結果按組 → 人 → 狀態回流至此。",
  "quantcode.admin.inputPlaceholder": "詢問：最近每組工作情況 / 各模組運行情況 / 各組錯誤記錄…",
  "quantcode.admin.send": "傳送查詢",
  "quantcode.admin.presetRuns": "最近每組工作情況",
  "quantcode.admin.presetModules": "各模組運行情況",
  "quantcode.admin.presetErrors": "各組錯誤記錄",
  "quantcode.admin.sent": "查詢指令已傳送，admin_* 結果回流後自動呈現。",
  "quantcode.admin.waiting": "等待 admin_* 結果回流…",
  "quantcode.admin.emptyTitle": "查詢通道尚未接通",
  "quantcode.admin.empty": "傳送語義查詢後，Agent 調用 admin_list_runs / admin_errors 的結果會回流到這裡；資料只來自真實通道，不造假。",
  "quantcode.admin.errorsEmpty": "暫無錯誤記錄，各組運行正常。",
  "quantcode.admin.filterAll": "全部",
  "quantcode.admin.reportsEntry": "報告管理",
  "quantcode.admin.tasksEntry": "任務管理",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph 全庫視圖",
  "quantcode.gitgraph.intro": "組織全部 repo 的最新樹狀態：有更新（7 天內有 push）的節點標紅置頂，可按組過濾。",
  "quantcode.gitgraph.check": "檢查更新",
  "quantcode.gitgraph.checked": "上次檢查",
  "quantcode.gitgraph.emptyTitle": "資料通道尚未接通",
  "quantcode.gitgraph.empty": "點擊「檢查更新」，Agent 調用 admin_repo_status / admin_package_updates 後，結果回流到這裡；資料只來自真實通道，不造假。",
  "quantcode.gitgraph.waiting": "等待 admin_repo_status 結果回流…",
  "quantcode.gitgraph.updated": "有更新",
  "quantcode.gitgraph.packagesEmpty": "依賴全部最新。",
  "quantcode.gitgraph.package": "依賴",
  "quantcode.gitgraph.open": "查看 GitGraph",
  "quantcode.pop.repoTitle": "倉庫有新提交",
  "quantcode.pop.packageTitle": "依賴有新版本",
