export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Genereres automatisk ud fra visningsnavnet. Du kan redigere det.",
  ...
  "provider.custom.action.fetchModels": "Hent modeller",
  "provider.custom.status.fetching": "Henter modeller…",
  "provider.custom.error.fetchFailed": "Kunne ikke hente modeller. Tilføj dem manuelt.",
  "provider.custom.hint.apiKeyEnv": "Hentning er ikke tilgængelig, mens API-nøglen bruger syntaksen {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Forbind en tredjepartsudbyder for at begynde at bruge modeller.",
  "sidebar.gettingStarted.line2": "Du behøver blot en basis-URL og en API-nøgle.",
  ...
  "settings.providers.add.thirdParty": "Tilføj tredjepartsudbyder",
  ...
  "quantcode.ssh.host": "Vært",
  "quantcode.ssh.user": "Bruger",
  "quantcode.ssh.privateKey": "Privat nøgle",
  "quantcode.ssh.privateKeyHint": "Den private nøgle sendes kun i hukommelsen til backenden — gemmes eller vises aldrig.",
  "quantcode.ssh.connect": "Forbind",
  "quantcode.ssh.connecting": "Forbinder…",
  "quantcode.ssh.logWaiting": "Venter på serverens svar…",
  "quantcode.ssh.connected": "Forbundet",
  "quantcode.ssh.fingerprint": "Fingeraftryk",
  "quantcode.ssh.groups": "Gruppetilknytning",
  "quantcode.ssh.groupSuffix": "gruppe",
  "quantcode.ssh.disconnect": "Afbryd",
  "quantcode.ssh.failed": "Forbindelsen mislykkedes",
  "quantcode.ssh.retry": "Prøv igen",
  "quantcode.ssh.reason.key_rejected": "Nøgle afvist",
  "quantcode.ssh.reason.host_unreachable": "Værten kan ikke nås",
  "quantcode.ssh.reason.unavailable": "SSH-forbindelsestjenesten er ikke klar endnu",

  "quantcode.capability.title": "Kapabilitetskatalog",
  "quantcode.capability.intro": "Organisationens registrerede kapabiliteter. Tjek her før løsningsdesign — genbrug i stedet for at opfinde.",
  "quantcode.capability.searchPlaceholder": "Søg kapabiliteter, API-flader eller anvendelser…",
  "quantcode.capability.ownerGroup": "Ejergruppe",
  "quantcode.capability.whenToUse": "Hvornår bruges",
  "quantcode.capability.whenNotToReinvent": "Hvornår må man ikke opfinde igen",
  "quantcode.capability.apiSurface": "API-flade",
  "quantcode.capability.source": "kilde",
  "quantcode.capability.noMatch": "Ingen matchende kapabilitetskort.",
  "quantcode.capability.empty": "Kapabilitetskatalog endnu ikke forbundet: venter på list_capabilities-metafunktion (via run trace eller injiceret fetcher).",
  "quantcode.memory.title": "Memory-forespørgsel",
  "quantcode.memory.intro": "Søg i gruppe- og delt Memory (skrivebeskyttet, på tværs af grupper fail-closed).",
  "quantcode.memory.searchPlaceholder": "Søg i forskningshukommelsen…",
  "quantcode.memory.search": "Søg",
  "quantcode.memory.empty": "Indtast nøgleord for at forespørge Memory.",
  "quantcode.memory.noResults": "Ingen matchende memory-poster.",
  "quantcode.memory.denied": "Ingen tilladelse: læsning af Memory på tværs af grupper afvist (fail-closed).",
  "quantcode.memory.unavailable": "Memory-kanal endnu ikke forbundet: venter på memory_search-værktøjet (injicerbar fetcher).",
  "quantcode.memory.score": "Relevans",
  "quantcode.solution.title": "Løsningspanel",
  "quantcode.solution.empty": "Ingen løsning i denne session endnu. Brug /solution <mål> for at starte løsning-først-flowet.",
  "quantcode.solution.draft": "Løsning ikke frossen",
  "quantcode.solution.draftHint": "Løsning ikke frossen — kodeværktøjer er utilgængelige. Diskutér og frys først (trivielle enkeltrettelser er undtaget).",
  "quantcode.solution.frozen": "Frossen",
  "quantcode.solution.rounds": "Diskussionsrunder",
  "quantcode.solution.revision": "Revision",
  "quantcode.solution.docHash": "doc_hash-slut",
  "quantcode.solution.solutionId": "Løsnings-ID",
  "quantcode.solution.verdict.conformant": "Implementeringen matcher løsningen",
  "quantcode.solution.verdict.deviation": "Afvigelse fundet",
  "quantcode.solution.verdict.needs_human": "Kræver menneskelig afgørelse",
  "quantcode.solution.deviatedFiles": "Afvigende filer",
  "quantcode.cmd.solution.title": "Start løsning (P-10)",
  "quantcode.cmd.solution.description": "Forudfylder draft_solution-aktivering; kodeværktøjer forbliver låst indtil frysning",
  "quantcode.cmd.solution.template": "Forskningsmål:\n<Beskriv målet her>\n\nDu SKAL nu kalde draft_solution-værktøjet (goal: målet ovenfor). Svar ikke med tekst. Kodeværktøjer er utilgængelige indtil freeze_solution — begynd ikke implementeringen.",
  "quantcode.cmd.deploy.title": "Blackbox-deployment (P-09)",
  "quantcode.cmd.deploy.description": "Forudfylder deploy_alphaflow-kald; deployment kræver kind=deploy-godkendelse",
  "quantcode.cmd.deploy.template": "Kildekode til deployment:\n<Sti eller beskrivelse her>\n\nDu SKAL nu kalde deploy_alphaflow-værktøjet (source: teksten ovenfor). Svar ikke med tekst. Rapportér kun tilpasning succes/fejl og artefaktstien — afslør aldrig AlphaFlows interne struktur.",
  "quantcode.admin.title": "Admin-konsol",
  "quantcode.admin.intro": "Spørg om organisationens tilstand på naturligt sprog; resultaterne fra admin_*-metaværktøjerne flyder tilbage hertil, grupperet efter gruppe → person → status.",
  "quantcode.admin.inputPlaceholder": "Spørg: seneste arbejde pr. gruppe / modulstatus / fejllogge…",
  "quantcode.admin.send": "Send forespørgsel",
  "quantcode.admin.presetRuns": "Seneste arbejde pr. gruppe",
  "quantcode.admin.presetModules": "Modulstatus",
  "quantcode.admin.presetErrors": "Fejllogge pr. gruppe",
  "quantcode.admin.sent": "Forespørgsel sendt; resultaterne vises, når admin_*-værktøjerne svarer tilbage.",
  "quantcode.admin.waiting": "Venter på admin_*-resultater…",
  "quantcode.admin.emptyTitle": "Datakanalen er endnu ikke forbundet",
  "quantcode.admin.empty": "Efter afsendelse lander resultaterne af admin_list_runs / admin_errors her. Kun rigtige data — ingen opdigtede.",
  "quantcode.admin.errorsEmpty": "Ingen fejl registreret; alle grupper kører normalt.",
  "quantcode.admin.filterAll": "Alle",
  "quantcode.admin.reportsEntry": "Rapporter",
  "quantcode.admin.tasksEntry": "Opgaver",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph-visning af alle repos",
  "quantcode.gitgraph.intro": "Seneste trætilstand for alle repos: noder med push inden for 7 dage fremhæves rødt og ligger øverst; filter pr. gruppe.",
  "quantcode.gitgraph.check": "Tjek opdateringer",
  "quantcode.gitgraph.checked": "Sidst tjekket",
  "quantcode.gitgraph.emptyTitle": "Datakanalen er endnu ikke forbundet",
  "quantcode.gitgraph.empty": "Klik på «Tjek opdateringer»; resultaterne af admin_repo_status / admin_package_updates lander her. Kun rigtige data.",
  "quantcode.gitgraph.waiting": "Venter på admin_repo_status-resultater…",
  "quantcode.gitgraph.updated": "Opdateret",
  "quantcode.gitgraph.packagesEmpty": "Alle afhængigheder er opdaterede.",
  "quantcode.gitgraph.package": "afhængighed",
  "quantcode.gitgraph.open": "Åbn GitGraph",
  "quantcode.pop.repoTitle": "Repoet har nye commits",
  "quantcode.pop.packageTitle": "Afhængighedsopdatering tilgængelig",
  "quantcode.pop.viewGitgraph": "Vis GitGraph",
}
