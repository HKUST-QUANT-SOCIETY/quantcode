export const dict = {
  ...
  "provider.custom.field.providerID.auto": "表示名から自動生成されます。編集できます。",
  ...
  "provider.custom.action.fetchModels": "モデルを取得",
  "provider.custom.status.fetching": "モデルを取得中…",
  "provider.custom.error.fetchFailed": "モデルの取得に失敗しました。手動で追加してください。",
  "provider.custom.hint.apiKeyEnv": "APIキーが {env:VAR} 構文を使用している場合、モデルの取得はできません。",
  ...
  "sidebar.gettingStarted.line1": "サードパーティのプロバイダーを接続して、モデルの利用を開始できます。",
  "sidebar.gettingStarted.line2": "必要なのはベースURLとAPIキーだけです。",
  ...
  "settings.providers.add.thirdParty": "サードパーティのプロバイダーを追加",
  ...
  "quantcode.ssh.host": "ホスト",
  "quantcode.ssh.user": "ユーザー名",
  "quantcode.ssh.privateKey": "秘密鍵",
  "quantcode.ssh.privateKeyHint": "秘密鍵はメモリ上でバックエンドへ渡されるだけで、保存や表示は行われません。",
  "quantcode.ssh.connect": "接続",
  "quantcode.ssh.connecting": "接続中…",
  "quantcode.ssh.logWaiting": "サーバーの応答を待っています…",
  "quantcode.ssh.connected": "接続済み",
  "quantcode.ssh.fingerprint": "フィンガープリント",
  "quantcode.ssh.groups": "グループ割り当て",
  "quantcode.ssh.groupSuffix": "グループ",
  "quantcode.ssh.disconnect": "切断",
  "quantcode.ssh.failed": "接続に失敗しました",
  "quantcode.ssh.retry": "再試行",
  "quantcode.ssh.reason.key_rejected": "鍵が拒否されました",
  "quantcode.ssh.reason.host_unreachable": "ホストに到達できません",
  "quantcode.ssh.reason.unavailable": "SSH 接続サービスはまだ準備中です",

  "quantcode.capability.title": "ケイパビリティカタログ",
  "quantcode.capability.intro": "組織に登録済みの研究能力。方案作成前にまず確認——再利用できれば自作しない。",
  "quantcode.capability.searchPlaceholder": "能力・API 面・用途を検索…",
  "quantcode.capability.ownerGroup": "所属グループ",
  "quantcode.capability.whenToUse": "使う場面",
  "quantcode.capability.whenNotToReinvent": "自作しない場面",
  "quantcode.capability.apiSurface": "API 面",
  "quantcode.capability.source": "ソース",
  "quantcode.capability.noMatch": "一致する能力カードがありません。",
  "quantcode.capability.empty": "ケイパビリティカタログは未接続：list_capabilities メタツール待ち（run trace または fetcher 注入）。",
  "quantcode.memory.title": "Memory 検索",
  "quantcode.memory.intro": "グループ内と共有 Memory を検索（読み取り専用、他グループは fail-closed）。",
  "quantcode.memory.searchPlaceholder": "研究メモリを検索…",
  "quantcode.memory.search": "検索",
  "quantcode.memory.empty": "キーワードを入力して Memory を検索してください。",
  "quantcode.memory.noResults": "一致するメモリ項目がありません。",
  "quantcode.memory.denied": "権限なし：他グループの Memory 読み取りは拒否されました（fail-closed）。",
  "quantcode.memory.unavailable": "Memory 検索チャネルは未接続：memory_search ツール待ち（fetcher 注入可）。",
  "quantcode.memory.score": "関連度",
  "quantcode.solution.title": "ソリューションパネル",
  "quantcode.solution.empty": "このセッションにはまだ方案がありません。/solution <目標> で方案先行フローを開始してください。",
  "quantcode.solution.draft": "方案未凍結",
  "quantcode.solution.draftHint": "方案が凍結されていないため、コードツールは使用できません。まず議論して凍結してください（些細な単点修正は免除）。",
  "quantcode.solution.frozen": "凍結済み",
  "quantcode.solution.rounds": "議論ラウンド",
  "quantcode.solution.revision": "改訂",
  "quantcode.solution.docHash": "doc_hash 末尾",
  "quantcode.solution.solutionId": "方案 ID",
  "quantcode.solution.verdict.conformant": "実装は方案に適合",
  "quantcode.solution.verdict.deviation": "逸脱あり",
  "quantcode.solution.verdict.needs_human": "人による判断が必要",
  "quantcode.solution.deviatedFiles": "逸脱ファイル一覧",
  "quantcode.cmd.solution.title": "方案開始（P-10）",
  "quantcode.cmd.solution.description": "draft_solution 起動文をプリフィル；凍結前はコードツール使用不可",
  "quantcode.cmd.solution.template": "研究目標：\n<解決したい研究目標をここに記述>\n\n今すぐ draft_solution ツールを呼び出してください（goal は上記の目標）。テキストで返信しないでください。方案が凍結（freeze_solution）されるまでコードツールは使用できないため、実装を開始しないでください。",
  "quantcode.cmd.deploy.title": "ブラックボックスデプロイ（P-09）",
  "quantcode.cmd.deploy.description": "deploy_alphaflow 呼び出し文をプリフィル；デプロイは kind=deploy 承認が必要",
  "quantcode.cmd.deploy.template": "デプロイするコードソース：\n<コードパスまたは説明をここに記入>\n\n今すぐ deploy_alphaflow ツールを呼び出してください（source は上記の内容）。テキストで返信しないでください。結果は適合の成否と artifact パスのみ報告し、AlphaFlow の内部構造は決して明かさないでください。",
  "quantcode.admin.title": "Admin コンソール",
  "quantcode.admin.intro": "自然言語で組織の稼働状況を照会します。Agent が admin_* メタツールを呼び出すと、結果がグループ → メンバー → ステータス単位でここに表示されます。",
  "quantcode.admin.inputPlaceholder": "質問：各グループの最近の状況 / モジュール別稼働状況 / グループ別エラーログ…",
  "quantcode.admin.send": "照会を送信",
  "quantcode.admin.presetRuns": "各グループの最近の稼働状況",
  "quantcode.admin.presetModules": "モジュール別稼働状況",
  "quantcode.admin.presetErrors": "グループ別エラーログ",
  "quantcode.admin.sent": "照会コマンドを送信しました。admin_* の結果が戻り次第表示されます。",
  "quantcode.admin.waiting": "admin_* の結果の回流を待っています…",
  "quantcode.admin.emptyTitle": "データチャネル未接続",
  "quantcode.admin.empty": "照会を送信すると、admin_list_runs / admin_errors の結果がここに表示されます。実データのみで、偽データはありません。",
  "quantcode.admin.errorsEmpty": "エラー記録はありません。各グループは正常に稼働中です。",
  "quantcode.admin.filterAll": "すべて",
  "quantcode.admin.reportsEntry": "レポート管理",
  "quantcode.admin.tasksEntry": "タスク管理",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph 全リポジトリビュー",
  "quantcode.gitgraph.intro": "組織の全 repo の最新ツリー状態：7 日以内に push のあったノードは赤で強調し先頭に表示、グループで絞り込めます。",
  "quantcode.gitgraph.check": "更新を確認",
  "quantcode.gitgraph.checked": "前回の確認",
  "quantcode.gitgraph.emptyTitle": "データチャネル未接続",
  "quantcode.gitgraph.empty": "「更新を確認」をクリックすると、admin_repo_status / admin_package_updates の結果がここに表示されます。実データのみで、偽データはありません。",
  "quantcode.gitgraph.waiting": "admin_repo_status の結果の回流を待っています…",
  "quantcode.gitgraph.updated": "更新あり",
  "quantcode.gitgraph.packagesEmpty": "依存関係はすべて最新です。",
  "quantcode.gitgraph.package": "依存",
  "quantcode.gitgraph.open": "GitGraph を開く",
  "quantcode.pop.repoTitle": "リポジトリに新しいコミット",
  "quantcode.pop.packageTitle": "依存パッケージの更新あり",
  "quantcode.pop.viewGitgraph": "GitGraph を表示",
}
