export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Se genera automáticamente a partir del nombre para mostrar. Puedes editarlo.",
  ...
  "provider.custom.action.fetchModels": "Obtener modelos",
  "provider.custom.status.fetching": "Obteniendo modelos…",
  "provider.custom.error.fetchFailed": "No se pudieron obtener los modelos. Añádelos manualmente.",
  "provider.custom.hint.apiKeyEnv": "La obtención no está disponible mientras la clave API use la sintaxis {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Conecta un proveedor de terceros para empezar a usar modelos.",
  "sidebar.gettingStarted.line2": "Solo necesitas una URL base y una clave API.",
  ...
  "settings.providers.add.thirdParty": "Añadir proveedor de terceros",
  ...
  "quantcode.ssh.user": "Usuario",
  "quantcode.ssh.privateKey": "Clave privada",
  "quantcode.ssh.privateKeyHint": "La clave privada se pasa al backend solo en memoria; nunca se guarda ni se muestra.",
  "quantcode.ssh.connect": "Conectar",
  "quantcode.ssh.connecting": "Conectando…",
  "quantcode.ssh.logWaiting": "Esperando respuesta del servidor…",
  "quantcode.ssh.connected": "Conectado",
  "quantcode.ssh.fingerprint": "Huella",
  "quantcode.ssh.groups": "Grupos asignados",
  "quantcode.ssh.groupSuffix": "grupo",
  "quantcode.ssh.disconnect": "Desconectar",
  "quantcode.ssh.failed": "Error de conexión",
  "quantcode.ssh.retry": "Reintentar",
  "quantcode.ssh.reason.key_rejected": "Clave rechazada",
  "quantcode.ssh.reason.host_unreachable": "Host inaccesible",
  "quantcode.ssh.reason.unavailable": "El servicio de conexión SSH aún no está listo",

  "quantcode.capability.title": "Catálogo de capacidades",
  "quantcode.capability.intro": "Capacidades de investigación registradas. Consulta aquí antes de redactar una solución — reutiliza, no reinventes.",
  "quantcode.capability.searchPlaceholder": "Buscar capacidades, superficies de API o usos…",
  "quantcode.capability.ownerGroup": "Grupo propietario",
  "quantcode.capability.whenToUse": "Cuándo usar",
  "quantcode.capability.whenNotToReinvent": "Cuándo no reinventar",
  "quantcode.capability.apiSurface": "Superficie de API",
  "quantcode.capability.source": "fuente",
  "quantcode.capability.noMatch": "No hay tarjetas de capacidad coincidentes.",
  "quantcode.capability.empty": "Catálogo aún no conectado: esperando la meta-herramienta list_capabilities (vía run trace o fetcher inyectado).",
  "quantcode.memory.title": "Consulta Memory",
  "quantcode.memory.intro": "Buscar en el Memory del grupo y compartido (solo lectura, entre grupos fail-closed).",
  "quantcode.memory.searchPlaceholder": "Buscar en la memoria de investigación…",
  "quantcode.memory.search": "Buscar",
  "quantcode.memory.empty": "Escribe palabras clave para consultar Memory.",
  "quantcode.memory.noResults": "No hay entradas de memoria coincidentes.",
  "quantcode.memory.denied": "Sin permiso: lectura entre grupos de Memory denegada (fail-closed).",
  "quantcode.memory.unavailable": "Canal de Memory aún no conectado: esperando la herramienta memory_search (fetcher inyectable).",
  "quantcode.memory.score": "Relevancia",
  "quantcode.solution.title": "Panel de solución",
  "quantcode.solution.empty": "Aún no hay solución en esta sesión. Usa /solution <objetivo> para iniciar el flujo de solución primero.",
  "quantcode.solution.draft": "Solución no congelada",
  "quantcode.solution.draftHint": "Solución no congelada — herramientas de código no disponibles. Discute y congela primero (las correcciones triviales puntuales quedan exentas).",
  "quantcode.solution.frozen": "Congelada",
  "quantcode.solution.rounds": "Rondas de discusión",
  "quantcode.solution.revision": "Revisión",
  "quantcode.solution.docHash": "final del doc_hash",
  "quantcode.solution.solutionId": "ID de solución",
  "quantcode.solution.verdict.conformant": "La implementación coincide con la solución",
  "quantcode.solution.verdict.deviation": "Desviación detectada",
  "quantcode.solution.verdict.needs_human": "Requiere decisión humana",
  "quantcode.solution.deviatedFiles": "Archivos desviados",
  "quantcode.cmd.solution.title": "Iniciar solución (P-10)",
  "quantcode.cmd.solution.description": "Prerrellena la activación de draft_solution; las herramientas de código siguen bloqueadas hasta congelar",
  "quantcode.cmd.solution.template": "Objetivo de investigación:\n<Describe aquí el objetivo>\n\nDebes llamar AHORA a la herramienta draft_solution (goal: el objetivo de arriba). No respondas con texto. Las herramientas de código no están disponibles hasta freeze_solution — no empieces a implementar.",
  "quantcode.cmd.deploy.title": "Despliegue caja negra (P-09)",
  "quantcode.cmd.deploy.description": "Prerrellena la llamada deploy_alphaflow; el despliegue requiere aprobación kind=deploy",
  "quantcode.cmd.deploy.template": "Fuente de código a desplegar:\n<Ruta o descripción aquí>\n\nDebes llamar AHORA a la herramienta deploy_alphaflow (source: el texto de arriba). No respondas con texto. Informa solo del éxito/fallo de adaptación y la ruta del artifact — nunca reveles la estructura interna de AlphaFlow.",
  "quantcode.admin.title": "Consola Admin",
  "quantcode.admin.intro": "Consulta el estado de la organización en lenguaje natural; los resultados de las metaherramientas admin_* regresan aquí, agrupados por grupo → miembro → estado.",
  "quantcode.admin.inputPlaceholder": "Preguntar: actividad reciente por grupo / estado de módulos / registros de errores…",
  "quantcode.admin.send": "Enviar consulta",
  "quantcode.admin.presetRuns": "Actividad reciente por grupo",
  "quantcode.admin.presetModules": "Estado de los módulos",
  "quantcode.admin.presetErrors": "Registros de errores por grupo",
  "quantcode.admin.sent": "Consulta enviada; los resultados aparecerán cuando respondan las herramientas admin_*.",
  "quantcode.admin.waiting": "Esperando resultados de admin_*…",
  "quantcode.admin.emptyTitle": "Canal de datos aún no conectado",
  "quantcode.admin.empty": "Tras enviar la consulta, los resultados de admin_list_runs / admin_errors llegarán aquí. Solo datos reales, sin simulaciones.",
  "quantcode.admin.errorsEmpty": "Sin errores registrados; todos los grupos funcionan con normalidad.",
  "quantcode.admin.filterAll": "Todos",
  "quantcode.admin.reportsEntry": "Informes",
  "quantcode.admin.tasksEntry": "Tareas",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "Vista GitGraph de todos los repos",
  "quantcode.gitgraph.intro": "Último estado del árbol de todos los repos: los nodos con push en los últimos 7 días se resaltan en rojo y quedan arriba; filtro por grupo.",
  "quantcode.gitgraph.check": "Comprobar actualizaciones",
  "quantcode.gitgraph.checked": "Última comprobación",
  "quantcode.gitgraph.emptyTitle": "Canal de datos aún no conectado",
  "quantcode.gitgraph.empty": "Pulsa «Comprobar actualizaciones»; los resultados de admin_repo_status / admin_package_updates llegarán aquí. Solo datos reales.",
  "quantcode.gitgraph.waiting": "Esperando resultados de admin_repo_status…",
  "quantcode.gitgraph.updated": "Actualizado",
  "quantcode.gitgraph.packagesEmpty": "Todas las dependencias están al día.",
  "quantcode.gitgraph.package": "dependencia",
  "quantcode.gitgraph.open": "Abrir GitGraph",
  "quantcode.pop.repoTitle": "El repo tiene nuevos commits",
  "quantcode.pop.packageTitle": "Actualización de dependencia disponible",
  "quantcode.pop.viewGitgraph": "Ver GitGraph",
}
