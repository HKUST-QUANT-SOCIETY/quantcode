...
export const dict = {
  "quantcode.servers.managedRuntime": "QuantCode 随桌面应用或组织发布更新。连接已有研究宿主时，添加其服务地址即可。",
  ...
  "provider.custom.field.providerID.auto": "根据显示名称自动生成，可手动修改。",
  ...
  "provider.custom.action.fetchModels": "获取模型列表",
  "provider.custom.status.fetching": "获取模型中…",
  "provider.custom.error.fetchFailed": "获取模型列表失败，请手动添加。",
  "provider.custom.hint.apiKeyEnv": "API 密钥使用 {env:VAR} 语法时无法获取模型列表。",
  ...
  "prompt.placeholder.commands": "描述任务，输入 / 使用命令，输入 @ 引用上下文…",
  ...
  "session.new.project.add": "选择研究项目",
  ...
  "sidebar.gettingStarted.line1": "绑定一个第三方供应商即可开始使用模型。",
  "sidebar.gettingStarted.line2": "只需填写基础 URL 和 API 密钥。",
  ...
  "settings.providers.add.thirdParty": "添加第三方供应商",
  ...
  "quantcode.gate.waitingApproval": "等待人工审批",
  "quantcode.gate.approve": "批准",
  "quantcode.gate.reject": "拒绝",
  "quantcode.gate.resuming": "恢复执行中…",
  "quantcode.gate.resumeSent": "已发送审批指令，等待 Agent 恢复执行",
  "quantcode.gate.resumeFailed": "审批指令发送失败",
  "quantcode.gate.riskMetrics": "风险指标",
  ...
  "quantcode.monitor.empty": "暂无本会话任务记录",
  "quantcode.monitor.recentRuns": "最近任务",
  "quantcode.monitor.runs": "任务",
  "quantcode.monitor.successRate": "成功率",
  "quantcode.monitor.avgDuration": "平均耗时",
  "quantcode.monitor.errorRate": "错误率",
  "quantcode.native.compose.description": "描述任务，在当前 QuantCode 会话中继续执行",
  "quantcode.native.goal.title": "设置任务目标",
  "quantcode.native.goal.description": "明确本次任务的完成目标与验收依据",
  "quantcode.native.goal.template": "任务目标：\n<描述期望完成的结果>\n\n验收标准：\n<列出用于确认完成的证据>",
  "quantcode.native.solution.title": "制定方案",
  "quantcode.native.solution.description": "说明变更内容、文件范围与验收要求",
  "quantcode.native.solution.template": "变更目标：\n<描述需要解决的问题>\n\n文件与影响范围：\n<列出相关文件或组件>\n\n验收要求：\n<说明如何核对完成结果>",
  "quantcode.native.skill": "组 Skill 自动加载",
  "quantcode.native.submitted": "任务已提交，可在任务界面查看进度。",
  "quantcode.native.return": "返回任务",
  "quantcode.native.checking": "正在核验任务服务…",
  "quantcode.native.unavailable": "无法核验任务服务，请重新连接后再提交。",
  "quantcode.native.legacyRecovery": "这是归档任务，目前仅支持查看。原执行环境核验完成前无法恢复，也不能作为新任务提交。",

  "quantcode.goal.title": "设置目标（运行后评测）",
  "quantcode.goal.description": "预填目标模板；任务完成后记录验收结果",
  "quantcode.goal.template":
    "目标：\n<在此描述可验证的完成标准，如：产出一份 IC≥0.03 的因子报告>\n\n要求：完成后记录用于核对结果的证据和理由。",
  ...
  "quantcode.capability.intro": "组织组件、公共契约与已登记接口。",
  ...
  "quantcode.memory.title": "长期知识库",
  "quantcode.memory.intro": "已确认的组内知识与获授权的公共契约。",
  "quantcode.memory.searchPlaceholder": "搜索研究记忆…",
  "quantcode.memory.search": "搜索",
  "quantcode.memory.empty": "尚未检索知识",
  "quantcode.memory.noResults": "没有匹配的记忆条目。",
  "quantcode.memory.denied": "当前身份无权读取这些知识。",
  "quantcode.memory.unavailable": "知识库暂不可用，请确认登录状态后重试。",
  ...
  "quantcode.cmd.solution.title": "发起方案（P-10）",
  "quantcode.cmd.solution.description": "预填 draft_solution 激活指令；方案冻结前代码工具不可用",
  "quantcode.cmd.solution.template": "研究目标：\n<在此描述要解决的研究目标>\n\n你现在必须调用 draft_solution 工具（goal 用上面的目标），不要回复文本。方案冻结（freeze_solution）之前代码工具不可用，不要开始实现。",
  "quantcode.cmd.deploy.title": "黑盒部署（P-09）",
  "quantcode.cmd.deploy.description": "预填 deploy_alphaflow 调用指令；部署需 kind=deploy 审批，结果不透露内部结构",
  "quantcode.cmd.deploy.template": "要部署的代码来源：\n<在此给出代码路径或描述>\n\n你现在必须调用 deploy_alphaflow 工具（source 用上面的内容），不要回复文本。结果只报告适配成败与 artifact 路径，不得透露 AlphaFlow 内部结构。",
