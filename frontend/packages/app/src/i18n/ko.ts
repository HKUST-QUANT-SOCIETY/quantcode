export const dict = {
  ...
  "provider.custom.field.providerID.auto": "표시 이름에서 자동 생성됩니다. 직접 수정할 수 있습니다.",
  ...
  "provider.custom.action.fetchModels": "모델 가져오기",
  "provider.custom.status.fetching": "모델 가져오는 중…",
  "provider.custom.error.fetchFailed": "모델을 가져오지 못했습니다. 직접 추가해 주세요.",
  "provider.custom.hint.apiKeyEnv": "API 키가 {env:VAR} 구문을 사용하는 동안에는 모델을 가져올 수 없습니다.",
  ...
  "sidebar.gettingStarted.line1": "서드파티 공급자를 연결하면 모델을 바로 사용할 수 있습니다.",
  "sidebar.gettingStarted.line2": "기본 URL과 API 키만 있으면 됩니다.",
  ...
  "settings.providers.add.thirdParty": "서드파티 공급자 추가",
  ...
  "quantcode.ssh.host": "호스트",
  "quantcode.ssh.user": "사용자 이름",
  "quantcode.ssh.privateKey": "개인 키",
  "quantcode.ssh.privateKeyHint": "개인 키는 메모리에서만 백엔드로 전달되며 저장되거나 표시되지 않습니다.",
  "quantcode.ssh.connect": "연결",
  "quantcode.ssh.connecting": "연결 중…",
  "quantcode.ssh.logWaiting": "서버 응답을 기다리는 중…",
  "quantcode.ssh.connected": "연결됨",
  "quantcode.ssh.fingerprint": "지문",
  "quantcode.ssh.groups": "그룹 바인딩",
  "quantcode.ssh.groupSuffix": "그룹",
  "quantcode.ssh.disconnect": "연결 해제",
  "quantcode.ssh.failed": "연결 실패",
  "quantcode.ssh.retry": "재시도",
  "quantcode.ssh.reason.key_rejected": "키가 거부되었습니다",
  "quantcode.ssh.reason.host_unreachable": "호스트에 연결할 수 없습니다",
  "quantcode.ssh.reason.unavailable": "SSH 연결 서비스가 아직 준비되지 않았습니다",

  "quantcode.capability.title": "역량 카탈로그",
  "quantcode.capability.intro": "조직에 등록된 연구 역량. 방안 작성 전 먼저 확인——재사용할 수 있으면 자작하지 않는다.",
  "quantcode.capability.searchPlaceholder": "역량·API 면·용도 검색…",
  "quantcode.capability.ownerGroup": "소유 그룹",
  "quantcode.capability.whenToUse": "사용 시점",
  "quantcode.capability.whenNotToReinvent": "자작 금지 시점",
  "quantcode.capability.apiSurface": "API 면",
  "quantcode.capability.source": "출처",
  "quantcode.capability.noMatch": "일치하는 역량 카드가 없습니다.",
  "quantcode.capability.empty": "역량 카탈로그 채널이 아직 연결되지 않았습니다: list_capabilities 메타 도구 대기 중(run trace 또는 fetcher 주입).",
  "quantcode.memory.title": "Memory 조회",
  "quantcode.memory.intro": "그룹 내·공유 Memory 검색(읽기 전용, 타 그룹 fail-closed).",
  "quantcode.memory.searchPlaceholder": "연구 메모리 검색…",
  "quantcode.memory.search": "검색",
  "quantcode.memory.empty": "키워드를 입력해 Memory를 조회하세요.",
  "quantcode.memory.noResults": "일치하는 메모리 항목이 없습니다.",
  "quantcode.memory.denied": "권한 없음: 타 그룹 Memory 읽기가 거부되었습니다(fail-closed).",
  "quantcode.memory.unavailable": "Memory 검색 채널이 아직 연결되지 않았습니다: memory_search 도구 대기 중(fetcher 주입 가능).",
  "quantcode.memory.score": "관련도",
  "quantcode.solution.title": "솔루션 패널",
  "quantcode.solution.empty": "이 세션에는 아직 솔루션이 없습니다. /solution <목표> 로 솔루션 선행 흐름을 시작하세요.",
  "quantcode.solution.draft": "솔루션 미동결",
  "quantcode.solution.draftHint": "솔루션이 동결되지 않아 코드 도구를 사용할 수 없습니다. 먼저 논의하고 동결하세요(사소한 단일 수정은 면제).",
  "quantcode.solution.frozen": "동결됨",
  "quantcode.solution.rounds": "논의 라운드",
  "quantcode.solution.revision": "수정",
  "quantcode.solution.docHash": "doc_hash 끝자리",
  "quantcode.solution.solutionId": "솔루션 ID",
  "quantcode.solution.verdict.conformant": "구현이 솔루션과 일치",
  "quantcode.solution.verdict.deviation": "편차 있음",
  "quantcode.solution.verdict.needs_human": "사람의 판단 필요",
  "quantcode.solution.deviatedFiles": "편차 파일 목록",
  "quantcode.cmd.solution.title": "솔루션 시작(P-10)",
  "quantcode.cmd.solution.description": "draft_solution 활성 지시문 프리필; 동결 전까지 코드 도구 사용 불가",
  "quantcode.cmd.solution.template": "연구 목표:\n<해결하려는 연구 목표를 여기에 기술>\n\n지금 즉시 draft_solution 도구를 호출하세요(goal: 위 목표). 텍스트로 답변하지 마세요. 솔루션이 동결(freeze_solution)되기 전까지 코드 도구는 사용할 수 없으므로 구현을 시작하지 마세요.",
  "quantcode.cmd.deploy.title": "블랙박스 배포(P-09)",
  "quantcode.cmd.deploy.description": "deploy_alphaflow 호출 지시문 프리필; 배포는 kind=deploy 승인 필요",
  "quantcode.cmd.deploy.template": "배포할 코드 소스:\n<코드 경로 또는 설명을 여기에 입력>\n\n지금 즉시 deploy_alphaflow 도구를 호출하세요(source: 위 내용). 텍스트로 답변하지 마세요. 결과는 적합 성공/실패와 artifact 경로만 보고하고 AlphaFlow 내부 구조는 절대 공개하지 마세요.",
  "quantcode.admin.title": "Admin 콘솔",
  "quantcode.admin.intro": "자연어로 조직 운영 상태를 조회합니다. Agent가 admin_* 메타 도구를 호출하면 결과가 그룹 → 멤버 → 상태별로 여기에 표시됩니다.",
  "quantcode.admin.inputPlaceholder": "질문: 각 그룹 최근 작업 / 모듈별 운영 상태 / 그룹별 오류 기록…",
  "quantcode.admin.send": "조회 전송",
  "quantcode.admin.presetRuns": "각 그룹 최근 작업 현황",
  "quantcode.admin.presetModules": "모듈별 운영 상태",
  "quantcode.admin.presetErrors": "그룹별 오류 기록",
  "quantcode.admin.sent": "조회 명령을 전송했습니다. admin_* 결과가 돌아오면 표시됩니다.",
  "quantcode.admin.waiting": "admin_* 결과를 기다리는 중…",
  "quantcode.admin.emptyTitle": "데이터 채널 미연결",
  "quantcode.admin.empty": "조회를 전송하면 admin_list_runs / admin_errors 결과가 여기에 표시됩니다. 실제 데이터만 사용하며 가짜 데이터는 없습니다.",
  "quantcode.admin.errorsEmpty": "오류 기록이 없습니다. 모든 그룹이 정상 운영 중입니다.",
  "quantcode.admin.filterAll": "전체",
  "quantcode.admin.reportsEntry": "보고서 관리",
  "quantcode.admin.tasksEntry": "작업 관리",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph 전체 저장소 뷰",
  "quantcode.gitgraph.intro": "조직 전체 repo의 최신 트리 상태: 7일 이내 push된 노드는 빨간색으로 강조되어 상단에 정렬되며 그룹별로 필터링할 수 있습니다.",
  "quantcode.gitgraph.check": "업데이트 확인",
  "quantcode.gitgraph.checked": "마지막 확인",
  "quantcode.gitgraph.emptyTitle": "데이터 채널 미연결",
  "quantcode.gitgraph.empty": "「업데이트 확인」을 클릭하면 admin_repo_status / admin_package_updates 결과가 여기에 표시됩니다. 실제 데이터만 사용합니다.",
  "quantcode.gitgraph.waiting": "admin_repo_status 결과를 기다리는 중…",
  "quantcode.gitgraph.updated": "업데이트 있음",
  "quantcode.gitgraph.packagesEmpty": "모든 의존성이 최신입니다.",
  "quantcode.gitgraph.package": "의존성",
  "quantcode.gitgraph.open": "GitGraph 열기",
  "quantcode.pop.repoTitle": "저장소에 새 커밋",
  "quantcode.pop.packageTitle": "의존성 업데이트 있음",
  "quantcode.pop.viewGitgraph": "GitGraph 보기",
}
