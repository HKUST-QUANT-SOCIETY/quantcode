...
export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Görünen addan otomatik oluşturulur. Düzenleyebilirsiniz.",
  ...
  "provider.custom.action.fetchModels": "Modelleri getir",
  "provider.custom.status.fetching": "Modeller getiriliyor…",
  "provider.custom.error.fetchFailed": "Modeller getirilemedi. Bunları elle ekleyin.",
  "provider.custom.hint.apiKeyEnv": "API anahtarı {env:VAR} sözdizimini kullanırken getirme kullanılamaz.",
  ...
  "sidebar.gettingStarted.line1": "Modelleri kullanmaya başlamak için üçüncü taraf bir sağlayıcı bağlayın.",
  "sidebar.gettingStarted.line2": "Tek ihtiyacınız olan şey bir temel URL ve bir API anahtarıdır.",
  ...
  "settings.providers.add.thirdParty": "Üçüncü taraf sağlayıcı ekle",
  ...
  "quantcode.ssh.host": "Sunucu",
  "quantcode.ssh.user": "Kullanıcı",
  "quantcode.ssh.privateKey": "Özel anahtar",
  "quantcode.ssh.privateKeyHint": "Özel anahtar yalnızca bellekte arka uca iletilir — asla kaydedilmez veya gösterilmez.",
  "quantcode.ssh.connect": "Bağlan",
  "quantcode.ssh.connecting": "Bağlanıyor…",
  "quantcode.ssh.logWaiting": "Sunucudan yanıt bekleniyor…",
  "quantcode.ssh.connected": "Bağlandı",
  "quantcode.ssh.fingerprint": "Parmak izi",
  "quantcode.ssh.groups": "Bağlı gruplar",
  "quantcode.ssh.groupSuffix": "grubu",
  "quantcode.ssh.disconnect": "Bağlantıyı kes",
  "quantcode.ssh.failed": "Bağlantı başarısız",
  "quantcode.ssh.retry": "Yeniden dene",
  "quantcode.ssh.reason.key_rejected": "Anahtar reddedildi",
  "quantcode.ssh.reason.host_unreachable": "Sunucuya ulaşılamıyor",
  "quantcode.ssh.reason.unavailable": "SSH bağlantı servisi henüz hazır değil",

  "quantcode.capability.title": "Yetenek kataloğu",
  "quantcode.capability.intro": "Organizasyonun kayıtlı araştırma yetenekleri. Çözüm tasarlamadan önce buraya bakın — yeniden icat etmeyin, yeniden kullanın.",
  "quantcode.capability.searchPlaceholder": "Yetenek, API yüzeyi veya kullanım ara…",
  "quantcode.capability.ownerGroup": "Sahip grup",
  "quantcode.capability.whenToUse": "Ne zaman kullanılır",
  "quantcode.capability.whenNotToReinvent": "Ne zaman yeniden icat edilmez",
  "quantcode.capability.apiSurface": "API yüzeyi",
  "quantcode.capability.source": "kaynak",
  "quantcode.capability.noMatch": "Eşleşen yetenek kartı yok.",
  "quantcode.capability.empty": "Yetenek kataloğu henüz bağlı değil: list_capabilities meta aracı bekleniyor (run trace veya enjekte fetcher ile).",
  "quantcode.memory.title": "Memory Sorgusu",
  "quantcode.memory.intro": "Grup içi ve paylaşılan Memory'de ara (salt okunur, gruplar arası fail-closed).",
  "quantcode.memory.searchPlaceholder": "Araştırma belleğinde ara…",
  "quantcode.memory.search": "Ara",
  "quantcode.memory.empty": "Memory sorgulamak için anahtar kelime girin.",
  "quantcode.memory.noResults": "Eşleşen bellek kaydı yok.",
  "quantcode.memory.denied": "İzin yok: gruplar arası Memory okuması reddedildi (fail-closed).",
  "quantcode.memory.unavailable": "Memory kanalı henüz bağlı değil: memory_search aracı bekleniyor (fetcher enjekte edilebilir).",
  "quantcode.memory.score": "İlgi",
  "quantcode.solution.title": "Çözüm paneli",
  "quantcode.solution.empty": "Bu oturumda henüz çözüm yok. Çözüm-önce akışını başlatmak için /solution <hedef> kullanın.",
  "quantcode.solution.draft": "Çözüm dondurulmadı",
  "quantcode.solution.draftHint": "Çözüm dondurulmadı — kod araçları kullanılamaz. Önce tartışın ve dondurun (basit tek nokta düzeltmeleri muaftır).",
  "quantcode.solution.frozen": "Donduruldu",
  "quantcode.solution.rounds": "Tartışma turları",
  "quantcode.solution.revision": "Revizyon",
  "quantcode.solution.docHash": "doc_hash kuyruğu",
  "quantcode.solution.solutionId": "Çözüm kimliği",
  "quantcode.solution.verdict.conformant": "Uygulama çözümle uyumlu",
  "quantcode.solution.verdict.deviation": "Sapma tespit edildi",
  "quantcode.solution.verdict.needs_human": "İnsan kararı gerekli",
  "quantcode.solution.deviatedFiles": "Sapan dosyalar listesi",
  "quantcode.cmd.solution.title": "Çözüm başlat (P-10)",
  "quantcode.cmd.solution.description": "draft_solution etkinleştirmesini öndoldurur; dondurulana kadar kod araçları kilitli",
  "quantcode.cmd.solution.template": "Araştırma hedefi:\n<Hedefi burada tanımlayın>\n\nŞİMDİ draft_solution aracını çağırmalısınız (goal: yukarıdaki hedef). Metinle yanıt vermeyin. freeze_solution'a kadar kod araçları kullanılamaz — uygulamaya başlamayın.",
  "quantcode.cmd.deploy.title": "Kara kutu dağıtımı (P-09)",
  "quantcode.cmd.deploy.description": "deploy_alphaflow çağrısını öndoldurur; dağıtım kind=deploy onayı gerektirir",
  "quantcode.cmd.deploy.template": "Dağıtılacak kod kaynağı:\n<Yol veya açıklama burada>\n\nŞİMDİ deploy_alphaflow aracını çağırmalısınız (source: yukarıdaki metin). Metinle yanıt vermeyin. Yalnızca uyarlama başarı/başarısızlığı ve artifact yolunu bildirin — AlphaFlow iç yapısını asla ifşa etmeyin.",
  "quantcode.admin.title": "Admin Konsolu",
  "quantcode.admin.intro": "Organizasyon durumunu doğal dille sorgulayın; admin_* meta araçlarının sonuçları grup → kişi → durum olarak buraya akar.",
  "quantcode.admin.inputPlaceholder": "Sor: gruplara göre son çalışmalar / modül durumları / hata kayıtları…",
  "quantcode.admin.send": "Sorguyu gönder",
  "quantcode.admin.presetRuns": "Gruplara göre son çalışmalar",
  "quantcode.admin.presetModules": "Modül durumları",
  "quantcode.admin.presetErrors": "Gruplara göre hata kayıtları",
  "quantcode.admin.sent": "Sorgu gönderildi; admin_* araçları döndüğünde sonuçlar burada görünecek.",
  "quantcode.admin.waiting": "admin_* sonuçları bekleniyor…",
  "quantcode.admin.emptyTitle": "Veri kanalı henüz bağlı değil",
  "quantcode.admin.empty": "Sorguyu gönderdikten sonra admin_list_runs / admin_errors sonuçları buraya gelir. Yalnızca gerçek veri — uydurma yok.",
  "quantcode.admin.errorsEmpty": "Kayıtlı hata yok; tüm gruplar normal çalışıyor.",
  "quantcode.admin.filterAll": "Tümü",
  "quantcode.admin.reportsEntry": "Raporlar",
  "quantcode.admin.tasksEntry": "Görevler",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph Tüm Depolar Görünümü",
  "quantcode.gitgraph.intro": "Tüm depoların en son ağaç durumu: son 7 günde push edilen düğümler kırmızı vurgulanır ve üste alınır; gruba göre filtrelenir.",
  "quantcode.gitgraph.check": "Güncellemeleri kontrol et",
  "quantcode.gitgraph.checked": "Son kontrol",
  "quantcode.gitgraph.emptyTitle": "Veri kanalı henüz bağlı değil",
  "quantcode.gitgraph.empty": "«Güncellemeleri kontrol et»e tıklayın; admin_repo_status / admin_package_updates sonuçları buraya gelir. Yalnızca gerçek veri.",
  "quantcode.gitgraph.waiting": "admin_repo_status sonuçları bekleniyor…",
  "quantcode.gitgraph.updated": "Güncel",
  "quantcode.gitgraph.packagesEmpty": "Tüm bağımlılıklar güncel.",
  "quantcode.gitgraph.package": "bağımlılık",
  "quantcode.gitgraph.open": "GitGraph'ı aç",
  "quantcode.pop.repoTitle": "Depoda yeni commit'ler var",
  "quantcode.pop.packageTitle": "Bağımlılık güncellemesi mevcut",
  "quantcode.pop.viewGitgraph": "GitGraph'ı gör",
