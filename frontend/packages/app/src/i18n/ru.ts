export const dict = {
  ...
  "provider.custom.field.providerID.auto": "Создаётся автоматически из отображаемого имени. Можно изменить.",
  ...
  "provider.custom.action.fetchModels": "Получить модели",
  "provider.custom.status.fetching": "Получение моделей…",
  "provider.custom.error.fetchFailed": "Не удалось получить модели. Добавьте их вручную.",
  "provider.custom.hint.apiKeyEnv": "Получение недоступно, пока ключ API использует синтаксис {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "Подключите стороннего провайдера, чтобы начать использовать модели.",
  "sidebar.gettingStarted.line2": "Всё, что нужно, — базовый URL и API-ключ.",
  ...
  "settings.providers.add.thirdParty": "Добавить стороннего провайдера",
  ...
  "quantcode.ssh.host": "Хост",
  "quantcode.ssh.user": "Пользователь",
  "quantcode.ssh.privateKey": "Приватный ключ",
  "quantcode.ssh.privateKeyHint": "Приватный ключ передаётся в бэкенд только в памяти — не сохраняется и не отображается.",
  "quantcode.ssh.connect": "Подключить",
  "quantcode.ssh.connecting": "Подключение…",
  "quantcode.ssh.logWaiting": "Ожидание ответа сервера…",
  "quantcode.ssh.connected": "Подключено",
  "quantcode.ssh.fingerprint": "Отпечаток",
  "quantcode.ssh.groups": "Привязка к группам",
  "quantcode.ssh.groupSuffix": "группа",
  "quantcode.ssh.disconnect": "Отключить",
  "quantcode.ssh.failed": "Не удалось подключиться",
  "quantcode.ssh.retry": "Повторить",
  "quantcode.ssh.reason.key_rejected": "Ключ отклонён",
  "quantcode.ssh.reason.host_unreachable": "Хост недоступен",
  "quantcode.ssh.reason.unavailable": "Служба SSH-подключения пока не готова",

  "quantcode.capability.title": "Каталог способностей",
  "quantcode.capability.intro": "Зарегистрированные способности организации. Проверяйте здесь до составления решения — переиспользуйте, а не изобретайте.",
  "quantcode.capability.searchPlaceholder": "Поиск способностей, API-поверхностей и применений…",
  "quantcode.capability.ownerGroup": "Группа-владелец",
  "quantcode.capability.whenToUse": "Когда использовать",
  "quantcode.capability.whenNotToReinvent": "Когда не изобретать заново",
  "quantcode.capability.apiSurface": "Поверхность API",
  "quantcode.capability.source": "источник",
  "quantcode.capability.noMatch": "Нет подходящих карточек способностей.",
  "quantcode.capability.empty": "Каталог ещё не подключён: ожидается мета-инструмент list_capabilities (через run trace или инъекцию fetcher).",
  "quantcode.memory.title": "Запрос Memory",
  "quantcode.memory.intro": "Поиск по групповому и общему Memory (только чтение, межгрупповой доступ fail-closed).",
  "quantcode.memory.searchPlaceholder": "Поиск по исследовательской памяти…",
  "quantcode.memory.search": "Найти",
  "quantcode.memory.empty": "Введите ключевые слова для запроса Memory.",
  "quantcode.memory.noResults": "Подходящих записей памяти нет.",
  "quantcode.memory.denied": "Нет прав: межгрупповое чтение Memory отклонено (fail-closed).",
  "quantcode.memory.unavailable": "Канал Memory ещё не подключён: ожидается инструмент memory_search (инъекция fetcher).",
  "quantcode.memory.score": "Релевантность",
  "quantcode.solution.title": "Панель решения",
  "quantcode.solution.empty": "В этой сессии ещё нет решения. Используйте /solution <цель>, чтобы запустить поток «сначала решение».",
  "quantcode.solution.draft": "Решение не заморожено",
  "quantcode.solution.draftHint": "Решение не заморожено — инструменты кода недоступны. Сначала обсудите и заморозьте решение (тривиальные точечные правки исключаются).",
  "quantcode.solution.frozen": "Заморожено",
  "quantcode.solution.rounds": "Раунды обсуждения",
  "quantcode.solution.revision": "Правка",
  "quantcode.solution.docHash": "конец doc_hash",
  "quantcode.solution.solutionId": "ID решения",
  "quantcode.solution.verdict.conformant": "Реализация соответствует решению",
  "quantcode.solution.verdict.deviation": "Обнаружено отклонение",
  "quantcode.solution.verdict.needs_human": "Требуется решение человека",
  "quantcode.solution.deviatedFiles": "Отклонившиеся файлы",
  "quantcode.cmd.solution.title": "Начать решение (P-10)",
  "quantcode.cmd.solution.description": "Предзаполняет активацию draft_solution; до заморозки инструменты кода недоступны",
  "quantcode.cmd.solution.template": "Цель исследования:\n<Опишите здесь цель>\n\nВы ДОЛЖНЫ немедленно вызвать инструмент draft_solution (goal: цель выше). Не отвечайте текстом. До freeze_solution инструменты кода недоступны — не начинайте реализацию.",
  "quantcode.cmd.deploy.title": "Деплой-чёрный ящик (P-09)",
  "quantcode.cmd.deploy.description": "Предзаполняет вызов deploy_alphaflow; деплой требует одобрения kind=deploy",
  "quantcode.cmd.deploy.template": "Источник кода для деплоя:\n<Путь или описание здесь>\n\nВы ДОЛЖНЫ немедленно вызвать инструмент deploy_alphaflow (source: текст выше). Не отвечайте текстом. Сообщайте только об успехе/неудаче адаптации и пути artifact — никогда не раскрывайте внутреннюю структуру AlphaFlow.",
  "quantcode.admin.title": "Консоль Admin",
  "quantcode.admin.intro": "Запрашивайте состояние организации на естественном языке; результаты мета-инструментов admin_* возвращаются сюда, сгруппированные по группе → участнику → статусу.",
  "quantcode.admin.inputPlaceholder": "Спросить: недавняя работа по группам / состояние модулей / журналы ошибок…",
  "quantcode.admin.send": "Отправить запрос",
  "quantcode.admin.presetRuns": "Недавняя работа по группам",
  "quantcode.admin.presetModules": "Состояние модулей",
  "quantcode.admin.presetErrors": "Журналы ошибок по группам",
  "quantcode.admin.sent": "Запрос отправлен; результаты появятся, когда вернутся инструменты admin_*.",
  "quantcode.admin.waiting": "Ожидание результатов admin_*…",
  "quantcode.admin.emptyTitle": "Канал данных ещё не подключён",
  "quantcode.admin.empty": "После отправки запроса результаты admin_list_runs / admin_errors появятся здесь. Только реальные данные — без выдумок.",
  "quantcode.admin.errorsEmpty": "Ошибок не зафиксировано; все группы работают штатно.",
  "quantcode.admin.filterAll": "Все",
  "quantcode.admin.reportsEntry": "Отчёты",
  "quantcode.admin.tasksEntry": "Задачи",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "GitGraph: все репозитории",
  "quantcode.gitgraph.intro": "Актуальное состояние дерева всех репозиториев: узлы с push за последние 7 дней выделены красным и подняты вверх; фильтр по группе.",
  "quantcode.gitgraph.check": "Проверить обновления",
  "quantcode.gitgraph.checked": "Последняя проверка",
  "quantcode.gitgraph.emptyTitle": "Канал данных ещё не подключён",
  "quantcode.gitgraph.empty": "Нажмите «Проверить обновления» — результаты admin_repo_status / admin_package_updates появятся здесь. Только реальные данные.",
  "quantcode.gitgraph.waiting": "Ожидание результатов admin_repo_status…",
  "quantcode.gitgraph.updated": "Есть обновления",
  "quantcode.gitgraph.packagesEmpty": "Все зависимости актуальны.",
  "quantcode.gitgraph.package": "зависимость",
  "quantcode.gitgraph.open": "Открыть GitGraph",
  "quantcode.pop.repoTitle": "В репозитории новые коммиты",
  "quantcode.pop.packageTitle": "Доступно обновление зависимости",
  "quantcode.pop.viewGitgraph": "Открыть GitGraph",
}
