export const dict = {
  ...
  "provider.custom.field.providerID.auto": "يتم إنشاؤه تلقائيًا من اسم العرض. يمكنك تعديله.",
  ...
  "provider.custom.action.fetchModels": "جلب النماذج",
  "provider.custom.status.fetching": "جارٍ جلب النماذج…",
  "provider.custom.error.fetchFailed": "فشل جلب النماذج. أضفها يدويًا.",
  "provider.custom.hint.apiKeyEnv": "الجلب غير متاح أثناء استخدام مفتاح API لصيغة {env:VAR}.",
  ...
  "sidebar.gettingStarted.line1": "قم بتوصيل مزود تابع لجهة خارجية لبدء استخدام النماذج.",
  "sidebar.gettingStarted.line2": "كل ما تحتاجه هو عنوان URL أساسي ومفتاح API.",
  ...
  "settings.providers.add.thirdParty": "إضافة مزود تابع لجهة خارجية",
  ...
  "quantcode.ssh.host": "المضيف",
  "quantcode.ssh.user": "المستخدم",
  "quantcode.ssh.privateKey": "المفتاح الخاص",
  "quantcode.ssh.privateKeyHint": "يُمرَّر المفتاح الخاص إلى الواجهة الخلفية في الذاكرة فقط — لا يُحفظ ولا يُعرض أبدًا.",
  "quantcode.ssh.connect": "اتصال",
  "quantcode.ssh.connecting": "جارٍ الاتصال…",
  "quantcode.ssh.logWaiting": "في انتظار رد الخادم…",
  "quantcode.ssh.connected": "متصل",
  "quantcode.ssh.fingerprint": "البصمة",
  "quantcode.ssh.groups": "المجموعات المرتبطة",
  "quantcode.ssh.groupSuffix": "مجموعة",
  "quantcode.ssh.disconnect": "قطع الاتصال",
  "quantcode.ssh.failed": "فشل الاتصال",
  "quantcode.ssh.retry": "إعادة المحاولة",
  "quantcode.ssh.reason.key_rejected": "تم رفض المفتاح",
  "quantcode.ssh.reason.host_unreachable": "المضيف غير قابل للوصول",
  "quantcode.ssh.reason.unavailable": "خدمة اتصال SSH غير جاهزة بعد",

  "quantcode.capability.title": "كتالوج القدرات",
  "quantcode.capability.intro": "قدرات البحث المسجلة للمنظمة. راجع هنا قبل صياغة أي حل — أعد الاستخدام ولا تخترع من جديد.",
  "quantcode.capability.searchPlaceholder": "ابحث في القدرات أو واجهات API أو حالات الاستخدام…",
  "quantcode.capability.ownerGroup": "المجموعة المالكة",
  "quantcode.capability.whenToUse": "متى تستخدم",
  "quantcode.capability.whenNotToReinvent": "متى لا تعيد الاختراع",
  "quantcode.capability.apiSurface": "سطح API",
  "quantcode.capability.source": "المصدر",
  "quantcode.capability.noMatch": "لا توجد بطاقات قدرات مطابقة.",
  "quantcode.capability.empty": "كتالوج القدرات غير متصل بعد: بانتظار أداة list_capabilities (عبر run trace أو مُحضِّر مُنحقَن).",
  "quantcode.memory.title": "استعلام Memory",
  "quantcode.memory.intro": "البحث في Memory الخاص بالمجموعة والمشترك (قراءة فقط، وعبر المجموعات fail-closed).",
  "quantcode.memory.searchPlaceholder": "ابحث في ذاكرة البحث…",
  "quantcode.memory.search": "بحث",
  "quantcode.memory.empty": "اكتب كلمات مفتاحية للاستعلام عن Memory.",
  "quantcode.memory.noResults": "لا توجد مدخلات ذاكرة مطابقة.",
  "quantcode.memory.denied": "لا إذن: رُفضت القراءة عبر المجموعات من Memory (fail-closed).",
  "quantcode.memory.unavailable": "قناة Memory غير متصلة بعد: بانتظار أداة memory_search (قابل لحقن fetcher).",
  "quantcode.memory.score": "الصلة",
  "quantcode.solution.title": "لوحة الحل",
  "quantcode.solution.empty": "لا يوجد حل في هذه الجلسة بعد. استخدم /solution <الهدف> لبدء مسار «الحل أولاً».",
  "quantcode.solution.draft": "الحل غير مجمد",
  "quantcode.solution.draftHint": "الحل غير مجمد — أدوات الكود غير متاحة. ناقش وجمّد الحل أولاً (الإصلاحات النقطية البسيطة مستثناة).",
  "quantcode.solution.frozen": "مجمّد",
  "quantcode.solution.rounds": "جولات النقاش",
  "quantcode.solution.revision": "مراجعة",
  "quantcode.solution.docHash": "ذيل doc_hash",
  "quantcode.solution.solutionId": "معرّف الحل",
  "quantcode.solution.verdict.conformant": "التنفيذ يطابق الحل",
  "quantcode.solution.verdict.deviation": "انحراف مكتشف",
  "quantcode.solution.verdict.needs_human": "يلزم قرار بشري",
  "quantcode.solution.deviatedFiles": "قائمة الملفات المنحرفة",
  "quantcode.cmd.solution.title": "بدء الحل (P-10)",
  "quantcode.cmd.solution.description": "تعبئة مسبقة لأمر تفعيل draft_solution؛ أدوات الكود تبقى غير متاحة حتى التجميد",
  "quantcode.cmd.solution.template": "هدف البحث:\n<صِف هدف البحث هنا>\n\nيجب أن تستدعي أداة draft_solution الآن (goal: الهدف أعلاه). لا ترد بنص. أدوات الكود غير متاحة حتى freeze_solution — لا تبدأ التنفيذ.",
  "quantcode.cmd.deploy.title": "نشر صندوق أسود (P-09)",
  "quantcode.cmd.deploy.description": "تعبئة مسبقة لاستدعاء deploy_alphaflow؛ النشر يتطلب موافقة kind=deploy",
  "quantcode.cmd.deploy.template": "مصدر الكود المطلوب نشره:\n<المسار أو الوصف هنا>\n\nيجب أن تستدعي أداة deploy_alphaflow الآن (source: النص أعلاه). لا ترد بنص. أبلغ فقط عن نجاح/فشل التكييف ومسار الـ artifact — ولا تكشف أبداً البنية الداخلية لـ AlphaFlow.",
  "quantcode.admin.title": "وحدة تحكم المشرف",
  "quantcode.admin.intro": "استعلم عن حالة المؤسسة بلغة طبيعية؛ تعود نتائج أدوات admin_* هنا مجمعة حسب المجموعة → العضو → الحالة.",
  "quantcode.admin.inputPlaceholder": "اسأل: عمل كل مجموعة الأخير / حالة الوحدات / سجلات الأخطاء…",
  "quantcode.admin.send": "إرسال الاستعلام",
  "quantcode.admin.presetRuns": "عمل كل مجموعة الأخير",
  "quantcode.admin.presetModules": "حالة الوحدات",
  "quantcode.admin.presetErrors": "سجلات أخطاء المجموعات",
  "quantcode.admin.sent": "تم إرسال الاستعلام؛ ستظهر النتائج عند عودة أدوات admin_*.",
  "quantcode.admin.waiting": "في انتظار نتائج admin_*…",
  "quantcode.admin.emptyTitle": "قناة البيانات غير متصلة بعد",
  "quantcode.admin.empty": "بعد الإرسال، ستصل نتائج admin_list_runs / admin_errors هنا. بيانات حقيقية فقط — بلا بيانات وهمية.",
  "quantcode.admin.errorsEmpty": "لا أخطاء مسجلة؛ جميع المجموعات تعمل بشكل طبيعي.",
  "quantcode.admin.filterAll": "الكل",
  "quantcode.admin.reportsEntry": "التقارير",
  "quantcode.admin.tasksEntry": "المهام",
  "quantcode.admin.q2Badge": "Q2",
  "quantcode.gitgraph.title": "عرض GitGraph لكل المستودعات",
  "quantcode.gitgraph.intro": "أحدث حالة شجرة لكل المستودعات: العقد التي تم دفعها خلال 7 أيام تُبرز بالأحمر وفي الأعلى؛ فلترة حسب المجموعة.",
  "quantcode.gitgraph.check": "التحقق من التحديثات",
  "quantcode.gitgraph.checked": "آخر تحقق",
  "quantcode.gitgraph.emptyTitle": "قناة البيانات غير متصلة بعد",
  "quantcode.gitgraph.empty": "انقر «التحقق من التحديثات»؛ ستصل نتائج admin_repo_status / admin_package_updates هنا. بيانات حقيقية فقط.",
  "quantcode.gitgraph.waiting": "في انتظار نتائج admin_repo_status…",
  "quantcode.gitgraph.updated": "به تحديث",
  "quantcode.gitgraph.packagesEmpty": "جميع التبعيات محدثة.",
  "quantcode.gitgraph.package": "تبعية",
  "quantcode.gitgraph.open": "افتح GitGraph",
  "quantcode.pop.repoTitle": "التزامات جديدة في المستودع",
  "quantcode.pop.packageTitle": "تحديث تبعية متوفر",
  "quantcode.pop.viewGitgraph": "عرض GitGraph",
}
