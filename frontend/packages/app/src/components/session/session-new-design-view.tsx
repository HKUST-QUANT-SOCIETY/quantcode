...
export function NewSessionDesignView(props: { children: JSX.Element }) {
  return (
    <div data-component="session-new-design" class={`relative size-full bg-v2-background-bg-deep ${isQuantCode ? "overflow-y-auto" : "overflow-hidden"}`}>
      <div class={isQuantCode ? "flex justify-center px-6 py-10" : "absolute inset-x-0 top-[25.375%] flex justify-center px-6"}>
