...
const api: ElectronAPI = {
  ...
  identity: {
    ...
    sshUnlockKey: () => ipcRenderer.invoke('quantcode-ssh-login-unlock-key'),
    sshAgentStatus: () => ipcRenderer.invoke('quantcode-ssh-agent-status'),
    sshStartAgent: () => ipcRenderer.invoke('quantcode-ssh-agent-start'),
    sshOpenAgentSettings: () => ipcRenderer.invoke('quantcode-ssh-agent-settings'),
    sshAgentKeys: () => ipcRenderer.invoke('quantcode-ssh-login-agent-keys'),
    sshSelectAgent: input => ipcRenderer.invoke('quantcode-ssh-login-select-agent', input),
    sshResolve: () => ipcRenderer.invoke('quantcode-ssh-login-resolve'),
    sshExitAttempt: () => ipcRenderer.invoke('quantcode-ssh-login-exit-attempt'),
    sshAcknowledge: input => ipcRenderer.invoke('quantcode-ssh-login-acknowledge', input),
